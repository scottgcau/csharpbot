...
import { VisitorsScheduleSubmission } from 'Models/Security/Acl/VisitorsScheduleSubmission';
...
export interface IScheduleSubmissionEntityAttributes extends IModelAttributes, SubmissionEntityData {
...
@entity('ScheduleSubmissionEntity', 'Schedule Submission')
// % protected region % [Customise your entity metadata here] end
export default class ScheduleSubmissionEntity extends Model implements IScheduleSubmissionEntityAttributes {
	public static acls: IAcl[] = [
		new SuperAdministratorScheme(),
		new VisitorsScheduleSubmission(),
	...
	@CRUD({
		...
		displayFunction: (attr, that) => (that as ScheduleSubmissionEntity).formVersion.version.toString(),
		onAfterChange: (model) => {
	...
	constructor(attributes?: Partial<IScheduleSubmissionEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IScheduleSubmissionEntityAttributes>) {
