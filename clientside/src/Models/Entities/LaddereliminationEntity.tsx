...
import { VisitorsLaddereliminationEntity } from 'Models/Security/Acl/VisitorsLaddereliminationEntity';
import { SystemuserLaddereliminationEntity } from 'Models/Security/Acl/SystemuserLaddereliminationEntity';
...
export interface ILaddereliminationEntityAttributes extends IModelAttributes {
	pointsfor: number;
	awatwon: number;
	awaylost: number;
	awayfor: number;
...
@entity('LaddereliminationEntity', 'LadderElimination')
// % protected region % [Customise your entity metadata here] end
export default class LaddereliminationEntity extends Model implements ILaddereliminationEntityAttributes {
	...
	// % protected region % [Modify props to the crud options here for attribute 'AwatWon'] off begin
	@Validators.Integer()
	@observable
	@attribute()
	@CRUD({
	...
	public awatwon: number;
	// % protected region % [Modify props to the crud options here for attribute 'AwatWon'] end
	...
	constructor(attributes?: Partial<ILaddereliminationEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<ILaddereliminationEntityAttributes>) {
		...
		if (attributes) {
			...
			if (attributes.awatwon) {
				this.awatwon = attributes.awatwon;
			}
