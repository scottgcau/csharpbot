...
import { VisitorsVenueSubmission } from 'Models/Security/Acl/VisitorsVenueSubmission';
...
export interface IVenueSubmissionEntityAttributes extends IModelAttributes, SubmissionEntityData {
...
@entity('VenueSubmissionEntity', 'Venue Submission')
// % protected region % [Customise your entity metadata here] end
export default class VenueSubmissionEntity extends Model implements IVenueSubmissionEntityAttributes {
	...
	@CRUD({
		...
		displayFunction: (attr, that) => (that as VenueSubmissionEntity).formVersion.version.toString(),
		onAfterChange: (model) => {
	...
	constructor(attributes?: Partial<IVenueSubmissionEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IVenueSubmissionEntityAttributes>) {
