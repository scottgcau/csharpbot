...
export interface ILeagueEntityFormTileEntityAttributes extends IModelAttributes {
	tile: string;

	formId: string;
	form: Models.LeagueEntity | Models.ILeagueEntityAttributes;
	// % protected region % [Add any custom attributes to the interface here] off begin
	// % protected region % [Add any custom attributes to the interface here] end
}

// % protected region % [Customise your entity metadata here] off begin
@entity('LeagueEntityFormTileEntity', 'League Entity Form Tile')
// % protected region % [Customise your entity metadata here] end
export default class LeagueEntityFormTileEntity extends Model implements ILeagueEntityFormTileEntityAttributes {
	...
	@CRUD({
		...
		formTileFilterFn: (option) => option.formModel === 'LeagueEntity',
	...
	public form: Models.LeagueEntity;

	// % protected region % [Add any custom attributes to the model here] off begin
	// % protected region % [Add any custom attributes to the model here] end

	constructor(attributes?: Partial<ILeagueEntityFormTileEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<ILeagueEntityFormTileEntityAttributes>) {
		...
		if (attributes) {
			...
			if (attributes.form) {
				if (attributes.form instanceof Models.LeagueEntity) {
					this.form = attributes.form;
					this.formId = attributes.form.id;
				} else {
					this.form = new Models.LeagueEntity(attributes.form);
