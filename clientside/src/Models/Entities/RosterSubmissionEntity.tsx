...
import { VisitorsRosterSubmission } from 'Models/Security/Acl/VisitorsRosterSubmission';
...
export interface IRosterSubmissionEntityAttributes extends IModelAttributes, SubmissionEntityData {
...
@entity('RosterSubmissionEntity', 'Roster Submission')
// % protected region % [Customise your entity metadata here] end
export default class RosterSubmissionEntity extends Model implements IRosterSubmissionEntityAttributes {
	public static acls: IAcl[] = [
		new SuperAdministratorScheme(),
		new VisitorsRosterSubmission(),
	...
	@CRUD({
		...
		displayFunction: (attr, that) => (that as RosterSubmissionEntity).formVersion.version.toString(),
		onAfterChange: (model) => {
	...
	constructor(attributes?: Partial<IRosterSubmissionEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IRosterSubmissionEntityAttributes>) {
