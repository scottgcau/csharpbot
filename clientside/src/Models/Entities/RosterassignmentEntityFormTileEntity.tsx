...
export interface IRosterassignmentEntityFormTileEntityAttributes extends IModelAttributes {
	tile: string;

	formId: string;
	form: Models.RosterassignmentEntity | Models.IRosterassignmentEntityAttributes;
	// % protected region % [Add any custom attributes to the interface here] off begin
	// % protected region % [Add any custom attributes to the interface here] end
}

// % protected region % [Customise your entity metadata here] off begin
@entity('RosterassignmentEntityFormTileEntity', 'RosterAssignment Entity Form Tile')
// % protected region % [Customise your entity metadata here] end
export default class RosterassignmentEntityFormTileEntity extends Model implements IRosterassignmentEntityFormTileEntityAttributes {
	...
	@CRUD({
		...
		formTileFilterFn: (option) => option.formModel === 'RosterassignmentEntity',
	...
	public form: Models.RosterassignmentEntity;

	// % protected region % [Add any custom attributes to the model here] off begin
	// % protected region % [Add any custom attributes to the model here] end

	constructor(attributes?: Partial<IRosterassignmentEntityFormTileEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IRosterassignmentEntityFormTileEntityAttributes>) {
		...
		if (attributes) {
			...
			if (attributes.form) {
				if (attributes.form instanceof Models.RosterassignmentEntity) {
					this.form = attributes.form;
					this.formId = attributes.form.id;
				} else {
					this.form = new Models.RosterassignmentEntity(attributes.form);
