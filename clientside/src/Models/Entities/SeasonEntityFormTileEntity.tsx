...
export interface ISeasonEntityFormTileEntityAttributes extends IModelAttributes {
	tile: string;

	formId: string;
	form: Models.SeasonEntity | Models.ISeasonEntityAttributes;
	// % protected region % [Add any custom attributes to the interface here] off begin
	// % protected region % [Add any custom attributes to the interface here] end
}

// % protected region % [Customise your entity metadata here] off begin
@entity('SeasonEntityFormTileEntity', 'Season Entity Form Tile')
// % protected region % [Customise your entity metadata here] end
export default class SeasonEntityFormTileEntity extends Model implements ISeasonEntityFormTileEntityAttributes {
	...
	@CRUD({
		...
		formTileFilterFn: (option) => option.formModel === 'SeasonEntity',
	...
	public form: Models.SeasonEntity;

	// % protected region % [Add any custom attributes to the model here] off begin
	// % protected region % [Add any custom attributes to the model here] end

	constructor(attributes?: Partial<ISeasonEntityFormTileEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<ISeasonEntityFormTileEntityAttributes>) {
		...
		if (attributes) {
			...
			if (attributes.form) {
				if (attributes.form instanceof Models.SeasonEntity) {
					this.form = attributes.form;
					this.formId = attributes.form.id;
				} else {
					this.form = new Models.SeasonEntity(attributes.form);
