...
export interface ISportEntityFormTileEntityAttributes extends IModelAttributes {
	tile: string;
...
@entity('SportEntityFormTileEntity', 'Sport Entity Form Tile')
// % protected region % [Customise your entity metadata here] end
export default class SportEntityFormTileEntity extends Model implements ISportEntityFormTileEntityAttributes {
	...
	@CRUD({
		...
		formTileFilterFn: (option) => option.formModel === 'SportEntity',
	...
	constructor(attributes?: Partial<ISportEntityFormTileEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<ISportEntityFormTileEntityAttributes>) {
