...
import { VisitorsGameSubmission } from 'Models/Security/Acl/VisitorsGameSubmission';
...
export interface IGameSubmissionEntityAttributes extends IModelAttributes, SubmissionEntityData {
...
@entity('GameSubmissionEntity', 'Game Submission')
// % protected region % [Customise your entity metadata here] end
export default class GameSubmissionEntity extends Model implements IGameSubmissionEntityAttributes {
	public static acls: IAcl[] = [
		new SuperAdministratorScheme(),
		new VisitorsGameSubmission(),
	...
	@CRUD({
		...
		displayFunction: (attr, that) => (that as GameSubmissionEntity).formVersion.version.toString(),
		onAfterChange: (model) => {
	...
	constructor(attributes?: Partial<IGameSubmissionEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IGameSubmissionEntityAttributes>) {
