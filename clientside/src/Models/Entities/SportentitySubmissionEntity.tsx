...
export interface ISportentitySubmissionEntityAttributes extends IModelAttributes, SubmissionEntityData {
...
@entity('SportentitySubmissionEntity', 'SportEntity Submission')
// % protected region % [Customise your entity metadata here] end
export default class SportentitySubmissionEntity extends Model implements ISportentitySubmissionEntityAttributes {
	...
	@CRUD({
		...
		referenceTypeFunc: () => Models.SportentityEntity,
		onAfterChange: (model) => {
	...
	constructor(attributes?: Partial<ISportentitySubmissionEntityAttributes>) {
	...
	public assignAttributes(attributes?: Partial<ISportentitySubmissionEntityAttributes>) {
