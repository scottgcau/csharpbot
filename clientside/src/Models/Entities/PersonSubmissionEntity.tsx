...
import { VisitorsPersonSubmission } from 'Models/Security/Acl/VisitorsPersonSubmission';
...
export interface IPersonSubmissionEntityAttributes extends IModelAttributes, SubmissionEntityData {
...
@entity('PersonSubmissionEntity', 'Person Submission')
// % protected region % [Customise your entity metadata here] end
export default class PersonSubmissionEntity extends Model implements IPersonSubmissionEntityAttributes {
	public static acls: IAcl[] = [
		new SuperAdministratorScheme(),
		new VisitorsPersonSubmission(),
	...
	@CRUD({
		...
		displayFunction: (attr, that) => (that as PersonSubmissionEntity).formVersion.version.toString(),
		onAfterChange: (model) => {
	...
	constructor(attributes?: Partial<IPersonSubmissionEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IPersonSubmissionEntityAttributes>) {
