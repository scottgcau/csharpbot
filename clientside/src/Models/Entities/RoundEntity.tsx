...
import { VisitorsRoundEntity } from 'Models/Security/Acl/VisitorsRoundEntity';
import { SystemuserRoundEntity } from 'Models/Security/Acl/SystemuserRoundEntity';
...
export interface IRoundEntityAttributes extends IModelAttributes {
	order: number;
	fullname: string;
	shortname: string;
...
@entity('RoundEntity', 'Round')
// % protected region % [Customise your entity metadata here] end
export default class RoundEntity extends Model implements IRoundEntityAttributes {
	...
	constructor(attributes?: Partial<IRoundEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IRoundEntityAttributes>) {
