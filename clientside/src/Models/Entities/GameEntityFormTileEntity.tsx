...
export interface IGameEntityFormTileEntityAttributes extends IModelAttributes {
	tile: string;

	formId: string;
	form: Models.GameEntity | Models.IGameEntityAttributes;
	// % protected region % [Add any custom attributes to the interface here] off begin
	// % protected region % [Add any custom attributes to the interface here] end
}

// % protected region % [Customise your entity metadata here] off begin
@entity('GameEntityFormTileEntity', 'Game Entity Form Tile')
// % protected region % [Customise your entity metadata here] end
export default class GameEntityFormTileEntity extends Model implements IGameEntityFormTileEntityAttributes {
	...
	@CRUD({
		...
		formTileFilterFn: (option) => option.formModel === 'GameEntity',
	...
	public form: Models.GameEntity;

	// % protected region % [Add any custom attributes to the model here] off begin
	// % protected region % [Add any custom attributes to the model here] end

	constructor(attributes?: Partial<IGameEntityFormTileEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IGameEntityFormTileEntityAttributes>) {
		...
		if (attributes) {
			...
			if (attributes.form) {
				if (attributes.form instanceof Models.GameEntity) {
					this.form = attributes.form;
					this.formId = attributes.form.id;
				} else {
					this.form = new Models.GameEntity(attributes.form);
