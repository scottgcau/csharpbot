...
import { VisitorsLeagueSubmission } from 'Models/Security/Acl/VisitorsLeagueSubmission';
...
export interface ILeagueSubmissionEntityAttributes extends IModelAttributes, SubmissionEntityData {
...
@entity('LeagueSubmissionEntity', 'League Submission')
// % protected region % [Customise your entity metadata here] end
export default class LeagueSubmissionEntity extends Model implements ILeagueSubmissionEntityAttributes {
	public static acls: IAcl[] = [
		new SuperAdministratorScheme(),
		new VisitorsLeagueSubmission(),
	...
	@CRUD({
		...
		displayFunction: (attr, that) => (that as LeagueSubmissionEntity).formVersion.version.toString(),
		onAfterChange: (model) => {
	...
	constructor(attributes?: Partial<ILeagueSubmissionEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<ILeagueSubmissionEntityAttributes>) {
