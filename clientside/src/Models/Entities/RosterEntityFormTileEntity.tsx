...
export interface IRosterEntityFormTileEntityAttributes extends IModelAttributes {
	tile: string;

	formId: string;
	form: Models.RosterEntity | Models.IRosterEntityAttributes;
	// % protected region % [Add any custom attributes to the interface here] off begin
	// % protected region % [Add any custom attributes to the interface here] end
}

// % protected region % [Customise your entity metadata here] off begin
@entity('RosterEntityFormTileEntity', 'Roster Entity Form Tile')
// % protected region % [Customise your entity metadata here] end
export default class RosterEntityFormTileEntity extends Model implements IRosterEntityFormTileEntityAttributes {
	...
	@CRUD({
		...
		formTileFilterFn: (option) => option.formModel === 'RosterEntity',
	...
	public form: Models.RosterEntity;

	// % protected region % [Add any custom attributes to the model here] off begin
	// % protected region % [Add any custom attributes to the model here] end

	constructor(attributes?: Partial<IRosterEntityFormTileEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IRosterEntityFormTileEntityAttributes>) {
		...
		if (attributes) {
			...
			if (attributes.form) {
				if (attributes.form instanceof Models.RosterEntity) {
					this.form = attributes.form;
					this.formId = attributes.form.id;
				} else {
					this.form = new Models.RosterEntity(attributes.form);
