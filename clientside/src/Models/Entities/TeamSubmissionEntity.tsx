...
import { VisitorsTeamSubmission } from 'Models/Security/Acl/VisitorsTeamSubmission';
...
export interface ITeamSubmissionEntityAttributes extends IModelAttributes, SubmissionEntityData {
...
@entity('TeamSubmissionEntity', 'Team Submission')
// % protected region % [Customise your entity metadata here] end
export default class TeamSubmissionEntity extends Model implements ITeamSubmissionEntityAttributes {
	public static acls: IAcl[] = [
		new SuperAdministratorScheme(),
		new VisitorsTeamSubmission(),
	...
	@CRUD({
		...
		displayFunction: (attr, that) => (that as TeamSubmissionEntity).formVersion.version.toString(),
		onAfterChange: (model) => {
	...
	constructor(attributes?: Partial<ITeamSubmissionEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<ITeamSubmissionEntityAttributes>) {
