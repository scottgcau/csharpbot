...
import { VisitorsRosterassignmentSubmission } from 'Models/Security/Acl/VisitorsRosterassignmentSubmission';
...
export interface IRosterassignmentSubmissionEntityAttributes extends IModelAttributes, SubmissionEntityData {
...
@entity('RosterassignmentSubmissionEntity', 'RosterAssignment Submission')
// % protected region % [Customise your entity metadata here] end
export default class RosterassignmentSubmissionEntity extends Model implements IRosterassignmentSubmissionEntityAttributes {
	public static acls: IAcl[] = [
		new SuperAdministratorScheme(),
		new VisitorsRosterassignmentSubmission(),
	...
	@CRUD({
		...
		displayFunction: (attr, that) => (that as RosterassignmentSubmissionEntity).formVersion.version.toString(),
		onAfterChange: (model) => {
	...
	constructor(attributes?: Partial<IRosterassignmentSubmissionEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IRosterassignmentSubmissionEntityAttributes>) {
