...
import { VisitorsSystemuserEntity } from 'Models/Security/Acl/VisitorsSystemuserEntity';
import { SystemuserSystemuserEntity } from 'Models/Security/Acl/SystemuserSystemuserEntity';
...
export interface ISystemuserEntityAttributes extends IModelAttributes {
	email: string;
...
@entity('SystemuserEntity', 'SystemUser')
// % protected region % [Customise your entity metadata here] end
export default class SystemuserEntity extends Model implements ISystemuserEntityAttributes {
	...
	@Validators.Custom('Password Match', (e: string, target: SystemuserEntity) => {
	...
	constructor(attributes?: Partial<ISystemuserEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<ISystemuserEntityAttributes>) {
