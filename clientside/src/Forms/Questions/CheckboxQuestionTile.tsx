...
@observer
export class CheckboxQuestionTileOptions extends React.Component<QuestionTileOptionsProps> {
	public render() {
		return (
...
export interface ICheckboxQuestionTileProps<T> extends IQuestionTileProps<T> {

}

@observer
export class CheckboxQuestionTile<T> extends React.Component<ICheckboxQuestionTileProps<T>> implements IQuestionTile {
