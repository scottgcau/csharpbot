...
export default class LeaguesWrappingTileTile extends React.Component<RouteComponentProps> {
// % protected region % [Add any customisations to default class definition here] end
	...
	public render() {
		...
		let contents = (
			<>
				<EntityCRUD {...this.props} modelType={Models.LeagueEntity} URLExtension={'Leaguescrud'}/>
			</>
		);
