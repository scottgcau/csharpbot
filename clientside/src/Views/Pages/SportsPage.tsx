...
import SportsWrappingTileTile from 'Views/Tiles/SportsWrappingTileTile';
...
@observer
export default class SportsPage extends React.Component<RouteComponentProps> {
