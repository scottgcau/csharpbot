...
@observer
export default class RosterassignmentEntityFormTileEntityPage extends React.Component<RouteComponentProps> {
	...
	public render() {
		...
		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD
					modelType={Models.RosterassignmentEntityFormTileEntity}
					{...this.props}
				/>
			</PageWrapper>
		);
