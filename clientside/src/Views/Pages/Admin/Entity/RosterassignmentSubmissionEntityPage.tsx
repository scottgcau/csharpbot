...
@observer
export default class RosterassignmentSubmissionEntityPage extends React.Component<RouteComponentProps> {
	...
	public render() {
		...
		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD
					modelType={Models.RosterassignmentSubmissionEntity}
					{...this.props}
				/>
			</PageWrapper>
		);
