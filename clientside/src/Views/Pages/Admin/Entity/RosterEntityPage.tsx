...
import {RosterEntity} from "Models/Entities";
// % protected region % [Add any extra imports here] off begin
// % protected region % [Add any extra imports here] end

@observer
export default class RosterEntityPage extends React.Component<RouteComponentProps> {
	...
	public render() {
		...
		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD
					modelType={Models.RosterEntity}
					actionsMore={[{
						label: 'View timeline',
						onEntityClick: (args: MenuItemEventHandler, entity: RosterEntity) => 
							this.props.history.push(`/admin/timelines/graph/Roster/${entity.id}`)
					}]}
					{...this.props}
				/>
			</PageWrapper>
