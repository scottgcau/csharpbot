...
{
	public class LeagueSubmissionEntity : BaseEntity
	{


		public LeagueSubmissionEntity()
		{
			EntityName = "LeagueSubmissionEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public LeagueSubmissionEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static LeagueSubmissionEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static LeagueSubmissionEntity GetInvalidEntity()
		{
			var leagueSubmissionEntity = new LeagueSubmissionEntity
			{
			};
			return leagueSubmissionEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static LeagueSubmissionEntity GetValidEntity(string fixedStrValue = null)
		{
			var leagueSubmissionEntity = new LeagueSubmissionEntity
			{
			};
		...
		{
			return SaveToDB<Sportstats.Models.LeagueSubmissionEntity>(LeagueSubmissionEntityDto.Convert(this));
		}
	}
}
