...
{
	public class RosterassignmentEntityFormTileEntity : BaseEntity
	{
		...
		public RosterassignmentEntityFormTileEntity()
		{
			EntityName = "RosterassignmentEntityFormTileEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public RosterassignmentEntityFormTileEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static RosterassignmentEntityFormTileEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static RosterassignmentEntityFormTileEntity GetInvalidEntity()
		{
			var rosterassignmentEntityFormTileEntity = new RosterassignmentEntityFormTileEntity
			{
				// not defining Tile
			};
			return rosterassignmentEntityFormTileEntity;
		}
		...
		private void SetValidEntityAssociations()
		{
			...
			FormId = new RosterassignmentEntity(ConfigureOptions.CREATE_ATTRIBUTES_AND_REFERENCES).Save();
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static RosterassignmentEntityFormTileEntity GetValidEntity(string fixedStrValue = null)
		{
			var rosterassignmentEntityFormTileEntity = new RosterassignmentEntityFormTileEntity
			{
		...
		{
			return SaveToDB<Sportstats.Models.RosterassignmentEntityFormTileEntity>(RosterassignmentEntityFormTileEntityDto.Convert(this));
		}
	}
}
