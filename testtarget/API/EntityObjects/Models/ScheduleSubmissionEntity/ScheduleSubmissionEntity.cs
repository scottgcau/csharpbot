...
{
	public class ScheduleSubmissionEntity : BaseEntity
	{


		public ScheduleSubmissionEntity()
		{
			EntityName = "ScheduleSubmissionEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public ScheduleSubmissionEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static ScheduleSubmissionEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static ScheduleSubmissionEntity GetInvalidEntity()
		{
			var scheduleSubmissionEntity = new ScheduleSubmissionEntity
			{
			};
			return scheduleSubmissionEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static ScheduleSubmissionEntity GetValidEntity(string fixedStrValue = null)
		{
			var scheduleSubmissionEntity = new ScheduleSubmissionEntity
			{
			};
		...
		{
			return SaveToDB<Sportstats.Models.ScheduleSubmissionEntity>(ScheduleSubmissionEntityDto.Convert(this));
		}
	}
}
