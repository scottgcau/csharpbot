...
{
	public class PersonSubmissionEntity : BaseEntity
	{


		public PersonSubmissionEntity()
		{
			EntityName = "PersonSubmissionEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public PersonSubmissionEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static PersonSubmissionEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static PersonSubmissionEntity GetInvalidEntity()
		{
			var personSubmissionEntity = new PersonSubmissionEntity
			{
			};
			return personSubmissionEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static PersonSubmissionEntity GetValidEntity(string fixedStrValue = null)
		{
			var personSubmissionEntity = new PersonSubmissionEntity
			{
			};
		...
		{
			return SaveToDB<Sportstats.Models.PersonSubmissionEntity>(PersonSubmissionEntityDto.Convert(this));
		}
	}
}
