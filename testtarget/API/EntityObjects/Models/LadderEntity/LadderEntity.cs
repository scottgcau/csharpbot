...
{
	public class LadderEntity : BaseEntity
	{
		// Type of ladder
		...
		public LadderEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		public override Dictionary<string, string> ToDictionary()
		{
			...
			{
				{"id" , Id.ToString()},
				{"laddertype" , Laddertype.ToString()},
			};
		...
		{
			Laddertype = LaddertypeEnum.GetRandomLaddertype();
		}
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static LadderEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static LadderEntity GetInvalidEntity()
		{
			var ladderEntity = new LadderEntity
			{
				Laddertype = LaddertypeEnum.GetRandomLaddertype(),
			};
			return ladderEntity;
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static LadderEntity GetValidEntity(string fixedStrValue = null)
		{
			var ladderEntity = new LadderEntity
			{
		...
		{
			return SaveToDB<Sportstats.Models.LadderEntity>(LadderEntityDto.Convert(this));
		}
	}
}
