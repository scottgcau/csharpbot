...
{
	public class GamerefereeEntity : BaseEntity
	{
		// 
		...
		public GamerefereeEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		private static string GetInvalidGameId(string validator)
		{
			switch (validator)
			{
				case "Required":
					return "";
				default:
					throw new Exception($"Cannot find validator {validator} for attribute GameReferees");
			}
		}
		...
		public override Dictionary<string, string> ToDictionary()
		{
			...
			{
				{"id" , Id.ToString()},
				{"headreferee" , Headreferee.ToString()},
			};
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static GamerefereeEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static GamerefereeEntity GetInvalidEntity()
		{
			var gamerefereeEntity = new GamerefereeEntity
			{
			};
		...
		private void SetValidEntityAttributes()
		{
			...
			Headreferee = DataUtils.RandBool();
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static GamerefereeEntity GetValidEntity(string fixedStrValue = null)
		{
			var gamerefereeEntity = new GamerefereeEntity
			{
		...
		{
			return SaveToDB<Sportstats.Models.GamerefereeEntity>(GamerefereeEntityDto.Convert(this));
		}
	}
}
