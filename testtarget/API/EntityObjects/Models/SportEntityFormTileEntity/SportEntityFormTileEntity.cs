...
{
	public class SportEntityFormTileEntity : BaseEntity
	{
		...
		public SportEntityFormTileEntity()
		{
			EntityName = "SportEntityFormTileEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public SportEntityFormTileEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static SportEntityFormTileEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static SportEntityFormTileEntity GetInvalidEntity()
		{
			var sportEntityFormTileEntity = new SportEntityFormTileEntity
			{
				// not defining Tile
			};
			return sportEntityFormTileEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static SportEntityFormTileEntity GetValidEntity(string fixedStrValue = null)
		{
			var sportEntityFormTileEntity = new SportEntityFormTileEntity
			{
		...
		{
			return SaveToDB<Sportstats.Models.SportEntityFormTileEntity>(SportEntityFormTileEntityDto.Convert(this));
		}
	}
}
