...
{
	public class RosterSubmissionEntity : BaseEntity
	{


		public RosterSubmissionEntity()
		{
			EntityName = "RosterSubmissionEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public RosterSubmissionEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static RosterSubmissionEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static RosterSubmissionEntity GetInvalidEntity()
		{
			var rosterSubmissionEntity = new RosterSubmissionEntity
			{
			};
			return rosterSubmissionEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static RosterSubmissionEntity GetValidEntity(string fixedStrValue = null)
		{
			var rosterSubmissionEntity = new RosterSubmissionEntity
			{
			};
		...
		{
			return SaveToDB<Sportstats.Models.RosterSubmissionEntity>(RosterSubmissionEntityDto.Convert(this));
		}
	}
}
