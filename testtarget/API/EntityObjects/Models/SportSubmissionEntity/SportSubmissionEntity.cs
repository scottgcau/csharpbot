...
{
	public class SportSubmissionEntity : BaseEntity
	{


		public SportSubmissionEntity()
		{
			EntityName = "SportSubmissionEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public SportSubmissionEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static SportSubmissionEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static SportSubmissionEntity GetInvalidEntity()
		{
			var sportSubmissionEntity = new SportSubmissionEntity
			{
			};
			return sportSubmissionEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static SportSubmissionEntity GetValidEntity(string fixedStrValue = null)
		{
			var sportSubmissionEntity = new SportSubmissionEntity
			{
			};
		...
		{
			return SaveToDB<Sportstats.Models.SportSubmissionEntity>(SportSubmissionEntityDto.Convert(this));
		}
	}
}
