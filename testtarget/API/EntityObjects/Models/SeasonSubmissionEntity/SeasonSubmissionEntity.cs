...
{
	public class SeasonSubmissionEntity : BaseEntity
	{


		public SeasonSubmissionEntity()
		{
			EntityName = "SeasonSubmissionEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public SeasonSubmissionEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static SeasonSubmissionEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static SeasonSubmissionEntity GetInvalidEntity()
		{
			var seasonSubmissionEntity = new SeasonSubmissionEntity
			{
			};
			return seasonSubmissionEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static SeasonSubmissionEntity GetValidEntity(string fixedStrValue = null)
		{
			var seasonSubmissionEntity = new SeasonSubmissionEntity
			{
			};
		...
		{
			return SaveToDB<Sportstats.Models.SeasonSubmissionEntity>(SeasonSubmissionEntityDto.Convert(this));
		}
	}
}
