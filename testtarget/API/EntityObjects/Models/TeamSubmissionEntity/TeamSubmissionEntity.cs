...
{
	public class TeamSubmissionEntity : BaseEntity
	{


		public TeamSubmissionEntity()
		{
			EntityName = "TeamSubmissionEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public TeamSubmissionEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static TeamSubmissionEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static TeamSubmissionEntity GetInvalidEntity()
		{
			var teamSubmissionEntity = new TeamSubmissionEntity
			{
			};
			return teamSubmissionEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static TeamSubmissionEntity GetValidEntity(string fixedStrValue = null)
		{
			var teamSubmissionEntity = new TeamSubmissionEntity
			{
			};
		...
		{
			return SaveToDB<Sportstats.Models.TeamSubmissionEntity>(TeamSubmissionEntityDto.Convert(this));
		}
	}
}
