...
namespace APITests.EntityObjects.Models
{
	public class RosterEntity : BaseEntity
	{
		...
		/// Outgoing one to many reference
		/// </summary>
		/// <see cref="Sportstats.Models.LoggedEvent"/>
		...
		public RosterEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static RosterEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static RosterEntity GetInvalidEntity()
		{
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static RosterEntity GetValidEntity(string fixedStrValue = null)
		{
			var rosterEntity = new RosterEntity
			{
		...
		{
			return SaveToDB<Sportstats.Models.RosterEntity>(RosterEntityDto.Convert(this));
		}
	}
}
