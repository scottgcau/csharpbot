...
{
	public class LeagueEntityFormTileEntity : BaseEntity
	{
		...
		public LeagueEntityFormTileEntity()
		{
			EntityName = "LeagueEntityFormTileEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public LeagueEntityFormTileEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static LeagueEntityFormTileEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static LeagueEntityFormTileEntity GetInvalidEntity()
		{
			var leagueEntityFormTileEntity = new LeagueEntityFormTileEntity
			{
				// not defining Tile
			};
			return leagueEntityFormTileEntity;
		}
		...
		private void SetValidEntityAssociations()
		{
			...
			FormId = new LeagueEntity(ConfigureOptions.CREATE_ATTRIBUTES_AND_REFERENCES).Save();
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static LeagueEntityFormTileEntity GetValidEntity(string fixedStrValue = null)
		{
			var leagueEntityFormTileEntity = new LeagueEntityFormTileEntity
			{
		...
		{
			return SaveToDB<Sportstats.Models.LeagueEntityFormTileEntity>(LeagueEntityFormTileEntityDto.Convert(this));
		}
	}
}
