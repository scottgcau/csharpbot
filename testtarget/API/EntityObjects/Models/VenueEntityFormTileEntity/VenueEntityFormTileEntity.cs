...
{
	public class VenueEntityFormTileEntity : BaseEntity
	{
		...
		public VenueEntityFormTileEntity()
		{
			EntityName = "VenueEntityFormTileEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public VenueEntityFormTileEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static VenueEntityFormTileEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static VenueEntityFormTileEntity GetInvalidEntity()
		{
			var venueEntityFormTileEntity = new VenueEntityFormTileEntity
			{
				// not defining Tile
			};
			return venueEntityFormTileEntity;
		}
		...
		private void SetValidEntityAssociations()
		{
			...
			FormId = new VenueEntity(ConfigureOptions.CREATE_ATTRIBUTES_AND_REFERENCES).Save();
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static VenueEntityFormTileEntity GetValidEntity(string fixedStrValue = null)
		{
			var venueEntityFormTileEntity = new VenueEntityFormTileEntity
			{
		...
		{
			return SaveToDB<Sportstats.Models.VenueEntityFormTileEntity>(VenueEntityFormTileEntityDto.Convert(this));
		}
	}
}
