...
{
	public class VenueSubmissionEntity : BaseEntity
	{


		public VenueSubmissionEntity()
		{
			EntityName = "VenueSubmissionEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public VenueSubmissionEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static VenueSubmissionEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static VenueSubmissionEntity GetInvalidEntity()
		{
			var venueSubmissionEntity = new VenueSubmissionEntity
			{
			};
			return venueSubmissionEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static VenueSubmissionEntity GetValidEntity(string fixedStrValue = null)
		{
			var venueSubmissionEntity = new VenueSubmissionEntity
			{
			};
		...
		{
			return SaveToDB<Sportstats.Models.VenueSubmissionEntity>(VenueSubmissionEntityDto.Convert(this));
		}
	}
}
