...
{
	public class PersonEntityFormTileEntity : BaseEntity
	{
		...
		public PersonEntityFormTileEntity()
		{
			EntityName = "PersonEntityFormTileEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public PersonEntityFormTileEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static PersonEntityFormTileEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static PersonEntityFormTileEntity GetInvalidEntity()
		{
			var personEntityFormTileEntity = new PersonEntityFormTileEntity
			{
				// not defining Tile
			};
			return personEntityFormTileEntity;
		}
		...
		private void SetValidEntityAssociations()
		{
			...
			FormId = new PersonEntity(ConfigureOptions.CREATE_ATTRIBUTES_AND_REFERENCES).Save();
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static PersonEntityFormTileEntity GetValidEntity(string fixedStrValue = null)
		{
			var personEntityFormTileEntity = new PersonEntityFormTileEntity
			{
		...
		{
			return SaveToDB<Sportstats.Models.PersonEntityFormTileEntity>(PersonEntityFormTileEntityDto.Convert(this));
		}
	}
}
