...
{
	public class ScheduleEntityFormTileEntity : BaseEntity
	{
		...
		public ScheduleEntityFormTileEntity()
		{
			EntityName = "ScheduleEntityFormTileEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public ScheduleEntityFormTileEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static ScheduleEntityFormTileEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static ScheduleEntityFormTileEntity GetInvalidEntity()
		{
			var scheduleEntityFormTileEntity = new ScheduleEntityFormTileEntity
			{
				// not defining Tile
			};
			return scheduleEntityFormTileEntity;
		}
		...
		private void SetValidEntityAssociations()
		{
			...
			FormId = new ScheduleEntity(ConfigureOptions.CREATE_ATTRIBUTES_AND_REFERENCES).Save();
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static ScheduleEntityFormTileEntity GetValidEntity(string fixedStrValue = null)
		{
			var scheduleEntityFormTileEntity = new ScheduleEntityFormTileEntity
			{
		...
		{
			return SaveToDB<Sportstats.Models.ScheduleEntityFormTileEntity>(ScheduleEntityFormTileEntityDto.Convert(this));
		}
	}
}
