...
{
	public class RosterassignmentSubmissionEntity : BaseEntity
	{


		public RosterassignmentSubmissionEntity()
		{
			EntityName = "RosterassignmentSubmissionEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public RosterassignmentSubmissionEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static RosterassignmentSubmissionEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static RosterassignmentSubmissionEntity GetInvalidEntity()
		{
			var rosterassignmentSubmissionEntity = new RosterassignmentSubmissionEntity
			{
			};
			return rosterassignmentSubmissionEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static RosterassignmentSubmissionEntity GetValidEntity(string fixedStrValue = null)
		{
			var rosterassignmentSubmissionEntity = new RosterassignmentSubmissionEntity
			{
			};
		...
		{
			return SaveToDB<Sportstats.Models.RosterassignmentSubmissionEntity>(RosterassignmentSubmissionEntityDto.Convert(this));
		}
	}
}
