...
{
	public class SeasonEntityFormTileEntity : BaseEntity
	{
		...
		public SeasonEntityFormTileEntity()
		{
			EntityName = "SeasonEntityFormTileEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public SeasonEntityFormTileEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static SeasonEntityFormTileEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static SeasonEntityFormTileEntity GetInvalidEntity()
		{
			var seasonEntityFormTileEntity = new SeasonEntityFormTileEntity
			{
				// not defining Tile
			};
			return seasonEntityFormTileEntity;
		}
		...
		private void SetValidEntityAssociations()
		{
			...
			FormId = new SeasonEntity(ConfigureOptions.CREATE_ATTRIBUTES_AND_REFERENCES).Save();
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static SeasonEntityFormTileEntity GetValidEntity(string fixedStrValue = null)
		{
			var seasonEntityFormTileEntity = new SeasonEntityFormTileEntity
			{
		...
		{
			return SaveToDB<Sportstats.Models.SeasonEntityFormTileEntity>(SeasonEntityFormTileEntityDto.Convert(this));
		}
	}
}
