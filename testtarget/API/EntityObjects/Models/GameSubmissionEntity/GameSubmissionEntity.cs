...
{
	public class GameSubmissionEntity : BaseEntity
	{


		public GameSubmissionEntity()
		{
			EntityName = "GameSubmissionEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public GameSubmissionEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static GameSubmissionEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static GameSubmissionEntity GetInvalidEntity()
		{
			var gameSubmissionEntity = new GameSubmissionEntity
			{
			};
			return gameSubmissionEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static GameSubmissionEntity GetValidEntity(string fixedStrValue = null)
		{
			var gameSubmissionEntity = new GameSubmissionEntity
			{
			};
		...
		{
			return SaveToDB<Sportstats.Models.GameSubmissionEntity>(GameSubmissionEntityDto.Convert(this));
		}
	}
}
