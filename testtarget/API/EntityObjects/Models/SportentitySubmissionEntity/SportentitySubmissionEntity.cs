...
{
	public class SportentitySubmissionEntity : BaseEntity	{


		public SportentitySubmissionEntity()
		{
			EntityName = "SportentitySubmissionEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public SportentitySubmissionEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static SportentitySubmissionEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static SportentitySubmissionEntity GetInvalidEntity()
		{
			var sportentitySubmissionEntity = new SportentitySubmissionEntity
			{
			};
			return sportentitySubmissionEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static SportentitySubmissionEntity GetValidEntity(string fixedStrValue = null)
		{
		...
		{
			return SaveToDB<Sportstats.Models.SportentitySubmissionEntity>(SportentitySubmissionEntityDto.Convert(this));
		}
	}
}
