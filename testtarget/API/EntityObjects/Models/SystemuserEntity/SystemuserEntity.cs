...
{
	public class SystemuserEntity : UserBaseEntity 
	{
		...
		public SystemuserEntity()
		{
			...
			EndpointName = "systemuser-entity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public SystemuserEntity(ConfigureOptions option)
		{
			EndpointName = "systemuser-entity";
			Configure(option);
			InitialiseAttributes();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static SystemuserEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static SystemuserEntity GetInvalidEntity()
		{
			var systemuserEntity = new SystemuserEntity
			{
			};
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static SystemuserEntity GetValidEntity(string fixedStrValue = null)
		{
			var systemuserEntity = new SystemuserEntity
			{
			};
