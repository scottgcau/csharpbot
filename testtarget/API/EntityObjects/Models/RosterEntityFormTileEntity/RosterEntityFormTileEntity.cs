...
{
	public class RosterEntityFormTileEntity : BaseEntity
	{
		...
		public RosterEntityFormTileEntity()
		{
			EntityName = "RosterEntityFormTileEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public RosterEntityFormTileEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static RosterEntityFormTileEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static RosterEntityFormTileEntity GetInvalidEntity()
		{
			var rosterEntityFormTileEntity = new RosterEntityFormTileEntity
			{
				// not defining Tile
			};
			return rosterEntityFormTileEntity;
		}
		...
		private void SetValidEntityAssociations()
		{
			...
			FormId = new RosterEntity(ConfigureOptions.CREATE_ATTRIBUTES_AND_REFERENCES).Save();
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static RosterEntityFormTileEntity GetValidEntity(string fixedStrValue = null)
		{
			var rosterEntityFormTileEntity = new RosterEntityFormTileEntity
			{
		...
		{
			return SaveToDB<Sportstats.Models.RosterEntityFormTileEntity>(RosterEntityFormTileEntityDto.Convert(this));
		}
	}
}
