...
{
	public class TeamEntityFormTileEntity : BaseEntity
	{
		...
		public TeamEntityFormTileEntity()
		{
			EntityName = "TeamEntityFormTileEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public TeamEntityFormTileEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static TeamEntityFormTileEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static TeamEntityFormTileEntity GetInvalidEntity()
		{
			var teamEntityFormTileEntity = new TeamEntityFormTileEntity
			{
				// not defining Tile
			};
			return teamEntityFormTileEntity;
		}
		...
		private void SetValidEntityAssociations()
		{
			...
			FormId = new TeamEntity(ConfigureOptions.CREATE_ATTRIBUTES_AND_REFERENCES).Save();
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static TeamEntityFormTileEntity GetValidEntity(string fixedStrValue = null)
		{
			var teamEntityFormTileEntity = new TeamEntityFormTileEntity
			{
		...
		{
			return SaveToDB<Sportstats.Models.TeamEntityFormTileEntity>(TeamEntityFormTileEntityDto.Convert(this));
		}
	}
}
