	...
	public class VisitorsReadTests : BaseReadTest
	{
		...
		public static TheoryData<IAbstractModel, bool, string> VisitorsReadSecurityData =>
			new TheoryData<IAbstractModel, bool, string>
			{
				...
				{new ScheduleSubmissionEntity(), true, "Visitors"},
				{new SeasonSubmissionEntity(), true, "Visitors"},
				{new VenueSubmissionEntity(), true, "Visitors"},
				{new GameSubmissionEntity(), true, "Visitors"},
				{new SportSubmissionEntity(), true, "Visitors"},
				{new LeagueSubmissionEntity(), true, "Visitors"},
				{new TeamSubmissionEntity(), true, "Visitors"},
				{new PersonSubmissionEntity(), true, "Visitors"},
				{new RosterSubmissionEntity(), true, "Visitors"},
				{new RosterassignmentSubmissionEntity(), true, "Visitors"},
				{new ScheduleEntityFormTileEntity(), true, "Visitors"},
				{new SeasonEntityFormTileEntity(), true, "Visitors"},
				{new VenueEntityFormTileEntity(), true, "Visitors"},
				{new GameEntityFormTileEntity(), true, "Visitors"},
				{new SportEntityFormTileEntity(), true, "Visitors"},
				{new LeagueEntityFormTileEntity(), true, "Visitors"},
				{new TeamEntityFormTileEntity(), true, "Visitors"},
				{new PersonEntityFormTileEntity(), true, "Visitors"},
				{new RosterEntityFormTileEntity(), true, "Visitors"},
				{new RosterassignmentEntityFormTileEntity(), true, "Visitors"},
