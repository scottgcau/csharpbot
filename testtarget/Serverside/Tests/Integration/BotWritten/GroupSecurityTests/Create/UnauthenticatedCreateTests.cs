	...
	public class UnauthenticatedCreateTest : BaseCreateTest
	{
		...
		public static TheoryData<IAbstractModel, string, string> UnauthenticatedCreateSecurityData =>
			new TheoryData<IAbstractModel, string,string>
			{
				...
				{new LadderEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new ScheduleEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new LaddereliminationEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new LadderwinlossEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new RoundEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new GameEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new DivisionEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new VenueEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new TeamEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new GamerefereeEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new SeasonEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new PersonEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new SportEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new LeagueEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new RosterEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new RosterassignmentEntity(), SecurityStringHelper.UserPermissionDenied, null},
				{new RosterTimelineEventsEntity(), SecurityStringHelper.UserPermissionDenied, null},
		...
		public static TheoryData<IAbstractModel, object, string, string> UnauthenticatedCreateUserSecurityData =>
			new TheoryData<IAbstractModel, object, string,string>
			{
				...
				{new SystemuserEntity(), new SystemuserEntityGraphQlRegistrationModel(), SecurityStringHelper.UserPermissionDenied, null},
