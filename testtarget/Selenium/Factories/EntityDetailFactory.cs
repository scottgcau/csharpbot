...
namespace SeleniumTests.Factories
{
	internal class EntityDetailFactory
	{
		...
		public IEntityDetailSection CreateDetailSection(string entityName, BaseEntity entity = null)
		{
			...
			{
				"LadderEntity" => new LadderEntityDetailSection(_contextConfiguration, (LadderEntity) entity),
				"ScheduleEntity" => new ScheduleEntityDetailSection(_contextConfiguration, (ScheduleEntity) entity),
				"LaddereliminationEntity" => new LaddereliminationEntityDetailSection(_contextConfiguration, (LaddereliminationEntity) entity),
				"LadderwinlossEntity" => new LadderwinlossEntityDetailSection(_contextConfiguration, (LadderwinlossEntity) entity),
				"RoundEntity" => new RoundEntityDetailSection(_contextConfiguration, (RoundEntity) entity),
				"GameEntity" => new GameEntityDetailSection(_contextConfiguration, (GameEntity) entity),
				"DivisionEntity" => new DivisionEntityDetailSection(_contextConfiguration, (DivisionEntity) entity),
				...
				"GamerefereeEntity" => new GamerefereeEntityDetailSection(_contextConfiguration, (GamerefereeEntity) entity),
				...
				"SystemuserEntity" => new SystemuserEntityDetailSection(_contextConfiguration, (SystemuserEntity) entity),
