...
###
@BotWritten @view
Feature: Admin Submenu User Feature
	
	@User
	Scenario: I attempt to navigate to the User entity page
	...
	And I click the User admin submenu
	Then I assert that I am on the User backend page
