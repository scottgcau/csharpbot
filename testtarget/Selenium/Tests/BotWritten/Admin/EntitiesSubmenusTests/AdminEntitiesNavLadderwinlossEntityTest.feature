...
Feature: Admin Submenu LadderwinlossEntity

	
	@LadderwinlossEntity
	Scenario: Admin Submenu LadderwinlossEntity
	...
	And I click the LadderWinLoss admin submenu
	Then I assert that I am on the LadderWinLoss Entity backend page