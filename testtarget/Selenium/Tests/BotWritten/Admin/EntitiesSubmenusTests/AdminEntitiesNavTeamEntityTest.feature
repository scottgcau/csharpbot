...
Feature: Admin Submenu TeamEntity

	
	@TeamEntity
	Scenario: Admin Submenu TeamEntity
	...
	And I click the Team admin submenu
	Then I assert that I am on the Team Entity backend page