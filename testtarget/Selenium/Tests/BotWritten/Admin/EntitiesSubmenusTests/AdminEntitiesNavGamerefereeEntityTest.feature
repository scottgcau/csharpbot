...
Feature: Admin Submenu GamerefereeEntity

	
	@GamerefereeEntity
	Scenario: Admin Submenu GamerefereeEntity
	...
	And I click the GameReferee admin submenu
	Then I assert that I am on the GameReferee Entity backend page