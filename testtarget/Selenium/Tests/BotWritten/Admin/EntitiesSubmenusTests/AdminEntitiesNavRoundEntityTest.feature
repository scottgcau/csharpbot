...
Feature: Admin Submenu RoundEntity

	
	@RoundEntity
	Scenario: Admin Submenu RoundEntity
	...
	And I click the Round admin submenu
	Then I assert that I am on the Round Entity backend page