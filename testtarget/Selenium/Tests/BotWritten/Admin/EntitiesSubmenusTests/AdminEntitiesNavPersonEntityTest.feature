...
Feature: Admin Submenu PersonEntity

	
	@PersonEntity
	Scenario: Admin Submenu PersonEntity
	...
	And I click the Person admin submenu
	Then I assert that I am on the Person Entity backend page