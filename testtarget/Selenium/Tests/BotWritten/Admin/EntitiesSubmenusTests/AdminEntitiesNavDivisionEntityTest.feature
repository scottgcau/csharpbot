...
Feature: Admin Submenu DivisionEntity

	
	@DivisionEntity
	Scenario: Admin Submenu DivisionEntity
	...
	And I click the Division admin submenu
	Then I assert that I am on the Division Entity backend page