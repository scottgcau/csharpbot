...
Feature: Admin Submenu LeagueEntity

	
	@LeagueEntity
	Scenario: Admin Submenu LeagueEntity
	...
	And I click the League admin submenu
	Then I assert that I am on the League Entity backend page