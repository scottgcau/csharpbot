...
Feature: Admin Submenu SportentityEntity
	
	@SportentityEntity
	Scenario: Admin Submenu SportentityEntity
	...
	And I click the SportEntity admin submenu
	Then I assert that I am on the SportEntity Entity backend page