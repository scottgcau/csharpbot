...
Feature: Admin Submenu VenueEntity

	
	@VenueEntity
	Scenario: Admin Submenu VenueEntity
	...
	And I click the Venue admin submenu
	Then I assert that I am on the Venue Entity backend page