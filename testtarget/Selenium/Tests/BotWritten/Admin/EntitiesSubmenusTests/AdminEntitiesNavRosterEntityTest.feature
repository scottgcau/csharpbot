...
Feature: Admin Submenu RosterEntity

	
	@RosterEntity
	Scenario: Admin Submenu RosterEntity
	...
	And I click the Roster admin submenu
	Then I assert that I am on the Roster Entity backend page