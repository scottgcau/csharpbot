...
Feature: Admin Submenu SeasonEntity

	
	@SeasonEntity
	Scenario: Admin Submenu SeasonEntity
	...
	And I click the Season admin submenu
	Then I assert that I am on the Season Entity backend page