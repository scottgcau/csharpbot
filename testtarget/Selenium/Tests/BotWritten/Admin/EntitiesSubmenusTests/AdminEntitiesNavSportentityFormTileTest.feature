...
Feature: Admin Submenu SportentityFormTile
	
	@SportentityFormTile
	Scenario: Admin Submenu SportentityFormTile
	...
	And I click the SportEntity Form Tile admin submenu
	Then I assert that I am on the SportEntity Form Tile backend page