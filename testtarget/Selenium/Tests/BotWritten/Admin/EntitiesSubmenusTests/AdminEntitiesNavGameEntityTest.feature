...
Feature: Admin Submenu GameEntity

	
	@GameEntity
	Scenario: Admin Submenu GameEntity
	...
	And I click the Game admin submenu
	Then I assert that I am on the Game Entity backend page