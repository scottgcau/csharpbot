...
Feature: Admin Submenu LaddereliminationEntity

	
	@LaddereliminationEntity
	Scenario: Admin Submenu LaddereliminationEntity
	...
	And I click the LadderElimination admin submenu
	Then I assert that I am on the LadderElimination Entity backend page