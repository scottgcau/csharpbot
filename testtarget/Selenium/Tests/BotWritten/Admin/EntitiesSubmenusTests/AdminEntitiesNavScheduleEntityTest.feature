...
Feature: Admin Submenu ScheduleEntity

	
	@ScheduleEntity
	Scenario: Admin Submenu ScheduleEntity
	...
	And I click the Schedule admin submenu
	Then I assert that I am on the Schedule Entity backend page