...
Feature: Admin Submenu LadderEntity

	
	@LadderEntity
	Scenario: Admin Submenu LadderEntity
	...
	And I click the Ladder admin submenu
	Then I assert that I am on the Ladder Entity backend page