...
Feature: SportentityFormTile Pagination Feature
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@SportentityFormTile
Scenario: Exceed upper pagination limit on SportentityFormTile
...
@SportentityFormTile
Scenario: Exceed lower pagination limit on SportentityFormTile
Given I login to the site as a user
And I navigate to the SportentityFormTile backend page
...
@SportentityFormTile
Scenario: SportentityFormTile next page
Given I login to the site as a user
And I navigate to the SportentityFormTile backend page
When I click on the next page button and validate page content
When I click on the next page button and validate page content
...
@SportentityFormTile
Scenario: SportentityFormTile previous page
Given I login to the site as a user
And I navigate to the SportentityFormTile backend page
When I click on the last page button and validate page content
When I click on the previous page button and validate page content
