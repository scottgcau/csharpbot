...
Feature: SportentityEntity Pagination Feature
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@SportentityEntity
Scenario: Exceed upper pagination limit on SportentityEntity
...
@SportentityEntity
Scenario: Exceed lower pagination limit on SportentityEntity
Given I login to the site as a user
And I navigate to the SportentityEntity backend page
...
@SportentityEntity
Scenario: SportentityEntity next page
Given I login to the site as a user
And I navigate to the SportentityEntity backend page
When I click on the next page button and validate page content
When I click on the next page button and validate page content
...
@SportentityEntity
Scenario: SportentityEntity previous page
Given I login to the site as a user
And I navigate to the SportentityEntity backend page
When I click on the last page button and validate page content
When I click on the previous page button and validate page content
