...
Feature: Reset VenueEntityFormTileEntity account password
# WARNING: These Tests have been flagged as ignored, until they are updated

Scenario: Reset VenueEntityFormTileEntity account password
Given I navigate to the request reset password page
	And I complete the form requesting to reset my VenueEntityFormTileEntity account password
