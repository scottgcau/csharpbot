...
Feature: Reset TeamEntityFormTileEntity account password
# WARNING: These Tests have been flagged as ignored, until they are updated

Scenario: Reset TeamEntityFormTileEntity account password
Given I navigate to the request reset password page
	And I complete the form requesting to reset my TeamEntityFormTileEntity account password
