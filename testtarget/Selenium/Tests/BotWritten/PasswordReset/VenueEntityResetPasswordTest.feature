...
Feature: Reset VenueEntity account password
# WARNING: These Tests have been flagged as ignored, until they are updated

Scenario: Reset VenueEntity account password
Given I navigate to the request reset password page
	And I complete the form requesting to reset my VenueEntity account password
