...
Feature: Reset LeagueEntityFormTileEntity account password
# WARNING: These Tests have been flagged as ignored, until they are updated

Scenario: Reset LeagueEntityFormTileEntity account password
Given I navigate to the request reset password page
	And I complete the form requesting to reset my LeagueEntityFormTileEntity account password
