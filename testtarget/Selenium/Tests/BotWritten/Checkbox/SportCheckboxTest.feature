...
@Sport
Scenario: Select all Sport entities on current page
Given I login to the site as a user
And I navigate to the Sport backend page
And I have 30 valid Sport entities
...
@Sport
Scenario: Verify Sport entity selection is persistant across pages
Given I login to the site as a user
And I navigate to the Sport backend page
And I have 30 valid Sport entities
When I select all entities on current page
...
@Sport
Scenario: Verify Sport entity checkboxes are persistant across pages
Given I login to the site as a user
And I navigate to the Sport backend page
And I have 30 valid Sport entities
When I select all entities on all pages
...
@Sport
Scenario: Sport checkbox single page deselect persistance test
Given I login to the site as a user
And I navigate to the Sport backend page
And I have 30 valid Sport entities
When I select all entities on current page
