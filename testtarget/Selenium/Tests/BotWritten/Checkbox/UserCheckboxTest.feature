...
@User
Scenario: Select all User entities on current page
Given I login to the site as a user
And I navigate to the User backend page
And I have 30 valid User entities
...
@User
Scenario: Verify User entity selection is persistant across pages
Given I login to the site as a user
And I navigate to the User backend page
And I have 30 valid User entities
When I select all entities on current page
...
@User
Scenario: Verify User entity checkboxes are persistant across pages
Given I login to the site as a user
And I navigate to the User backend page
And I have 30 valid User entities
When I select all entities on all pages
...
@User
Scenario: User checkbox single page deselect persistance test
Given I login to the site as a user
And I navigate to the User backend page
And I have 30 valid User entities
When I select all entities on current page
