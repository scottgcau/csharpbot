...
@League
Scenario: Select all League entities on current page
Given I login to the site as a user
And I navigate to the League backend page
And I have 30 valid League entities
...
@League
Scenario: Verify League entity selection is persistant across pages
Given I login to the site as a user
And I navigate to the League backend page
And I have 30 valid League entities
When I select all entities on current page
...
@League
Scenario: Verify League entity checkboxes are persistant across pages
Given I login to the site as a user
And I navigate to the League backend page
And I have 30 valid League entities
When I select all entities on all pages
...
@League
Scenario: League checkbox single page deselect persistance test
Given I login to the site as a user
And I navigate to the League backend page
And I have 30 valid League entities
When I select all entities on current page
