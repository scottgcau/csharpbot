...
Feature: SportentityFormTile Checkbox
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@SportentityFormTile
Scenario: Select all SportentityFormTile entities across pages
Given I login to the site as a user
And I navigate to the SportentityFormTile backend page
And I have 30 valid SportentityFormTile entities
...
@SportentityFormTile
Scenario: Select all SportentityFormTile entities on current page
Given I login to the site as a user
And I navigate to the SportentityFormTile backend page
And I have 30 valid SportentityFormTile entities
...
@SportentityFormTile
Scenario: Verify SportentityFormTile entity selection is persistant across pages
Given I login to the site as a user
And I navigate to the SportentityFormTile backend page
And I have 30 valid SportentityFormTile entities
When I select all entities on current page
...
@SportentityFormTile
Scenario: Verify SportentityFormTile entity checkboxes are persistant across pages
Given I login to the site as a user
And I navigate to the SportentityFormTile backend page
And I have 30 valid SportentityFormTile entities
When I select all entities on all pages
...
@SportentityFormTile
Scenario: SportentityFormTile checkbox single page deselect persistance test
Given I login to the site as a user
And I navigate to the SportentityFormTile backend page
And I have 30 valid SportentityFormTile entities
When I select all entities on current page
