...
@SportentityEntity
Scenario: Select all SportentityEntity entities on current page
Given I login to the site as a user
And I navigate to the SportentityEntity backend page
And I have 30 valid SportentityEntity entities
...
@SportentityEntity
Scenario: Verify SportentityEntity entity selection is persistant across pages
Given I login to the site as a user
And I navigate to the SportentityEntity backend page
And I have 30 valid SportentityEntity entities
When I select all entities on current page
...
@SportentityEntity
Scenario: Verify SportentityEntity entity checkboxes are persistant across pages
Given I login to the site as a user
And I navigate to the SportentityEntity backend page
And I have 30 valid SportentityEntity entities
When I select all entities on all pages
...
@SportentityEntity
Scenario: SportentityEntity checkbox single page deselect persistance test
Given I login to the site as a user
And I navigate to the SportentityEntity backend page
And I have 30 valid SportentityEntity entities
When I select all entities on current page
