...
Feature: ScheduleEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@ScheduleEntity
Scenario: Select all ScheduleEntitys on current page
...
@ScheduleEntity
Scenario: I attempt to select all ScheduleEntitys on all pages
Given I login to the site as a user
And I navigate to the ScheduleEntity backend page
When I select all entities on current page
