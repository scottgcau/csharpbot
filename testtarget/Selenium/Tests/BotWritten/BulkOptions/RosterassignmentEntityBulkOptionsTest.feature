...
Feature: RosterassignmentEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@RosterassignmentEntity
Scenario: Select all RosterassignmentEntitys on current page
...
@RosterassignmentEntity
Scenario: I attempt to select all RosterassignmentEntitys on all pages
Given I login to the site as a user
And I navigate to the RosterassignmentEntity backend page
When I select all entities on current page
