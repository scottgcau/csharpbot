...
Feature: RosterEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@RosterEntity
Scenario: Select all RosterEntitys on current page
...
@RosterEntity
Scenario: I attempt to select all RosterEntitys on all pages
Given I login to the site as a user
And I navigate to the RosterEntity backend page
When I select all entities on current page
