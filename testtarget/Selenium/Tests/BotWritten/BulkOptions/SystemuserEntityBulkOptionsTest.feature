...
Feature: SystemuserEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@SystemuserEntity
Scenario: Select all SystemuserEntitys on current page
...
@SystemuserEntity
Scenario: I attempt to select all SystemuserEntitys on all pages
Given I login to the site as a user
And I navigate to the SystemuserEntity backend page
When I select all entities on current page
