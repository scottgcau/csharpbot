...
Feature: LadderwinlossEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@LadderwinlossEntity
Scenario: Select all LadderwinlossEntitys on current page
...
@LadderwinlossEntity
Scenario: I attempt to select all LadderwinlossEntitys on all pages
Given I login to the site as a user
And I navigate to the LadderwinlossEntity backend page
When I select all entities on current page
