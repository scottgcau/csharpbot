...
Feature: SportentityEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@SportentityEntity
Scenario: Select all SportentityEntitys on current page
...
@SportentityEntity
Scenario: I attempt to select all SportentityEntitys on all pages
Given I login to the site as a user
And I navigate to the SportentityEntity backend page
When I select all entities on current page
