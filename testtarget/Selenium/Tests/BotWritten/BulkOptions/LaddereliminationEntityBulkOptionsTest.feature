...
Feature: LaddereliminationEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@LaddereliminationEntity
Scenario: Select all LaddereliminationEntitys on current page
...
@LaddereliminationEntity
Scenario: I attempt to select all LaddereliminationEntitys on all pages
Given I login to the site as a user
And I navigate to the LaddereliminationEntity backend page
When I select all entities on current page
