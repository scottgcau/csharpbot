...
Feature: LadderEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@LadderEntity
Scenario: Select all LadderEntitys on current page
...
@LadderEntity
Scenario: I attempt to select all LadderEntitys on all pages
Given I login to the site as a user
And I navigate to the LadderEntity backend page
When I select all entities on current page
