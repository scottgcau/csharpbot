...
Feature: PersonEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@PersonEntity
Scenario: Select all PersonEntitys on current page
...
@PersonEntity
Scenario: I attempt to select all PersonEntitys on all pages
Given I login to the site as a user
And I navigate to the PersonEntity backend page
When I select all entities on current page
