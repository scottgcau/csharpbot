...
Feature: SeasonEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@SeasonEntity
Scenario: Select all SeasonEntitys on current page
...
@SeasonEntity
Scenario: I attempt to select all SeasonEntitys on all pages
Given I login to the site as a user
And I navigate to the SeasonEntity backend page
When I select all entities on current page
