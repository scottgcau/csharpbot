...
Feature: LeagueEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@LeagueEntity
Scenario: Select all LeagueEntitys on current page
...
@LeagueEntity
Scenario: I attempt to select all LeagueEntitys on all pages
Given I login to the site as a user
And I navigate to the LeagueEntity backend page
When I select all entities on current page
