...
Feature: SportentityFormTile Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@SportentityFormTile
Scenario: Select all SportentityFormTiles on current page
...
@SportentityFormTile
Scenario: I attempt to select all SportentityFormTiles on all pages
Given I login to the site as a user
And I navigate to the SportentityFormTile backend page
When I select all entities on current page
