...
Feature: GamerefereeEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@GamerefereeEntity
Scenario: Select all GamerefereeEntitys on current page
...
@GamerefereeEntity
Scenario: I attempt to select all GamerefereeEntitys on all pages
Given I login to the site as a user
And I navigate to the GamerefereeEntity backend page
When I select all entities on current page
