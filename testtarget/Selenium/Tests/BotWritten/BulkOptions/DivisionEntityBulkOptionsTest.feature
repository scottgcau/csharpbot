...
Feature: DivisionEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@DivisionEntity
Scenario: Select all DivisionEntitys on current page
...
@DivisionEntity
Scenario: I attempt to select all DivisionEntitys on all pages
Given I login to the site as a user
And I navigate to the DivisionEntity backend page
When I select all entities on current page
