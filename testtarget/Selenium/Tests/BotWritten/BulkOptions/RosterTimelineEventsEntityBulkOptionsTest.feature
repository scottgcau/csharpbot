...
Feature: RosterTimelineEventsEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@RosterTimelineEventsEntity
Scenario: Select all RosterTimelineEventsEntitys on current page
...
@RosterTimelineEventsEntity
Scenario: I attempt to select all RosterTimelineEventsEntitys on all pages
Given I login to the site as a user
And I navigate to the RosterTimelineEventsEntity backend page
When I select all entities on current page
