...
@BotWritten @Filter
Feature: Sport filtered by future's created and modifed and search Feature

@Sport
Scenario: Sport filtered by future's created and modifed and search
Given I login to the site as a user
Given I have 10 valid Sport entities
And I have 1 valid Sport entities with fixed string values BlaBla_StringToSearch_BlaBla
And I navigate to the Sport backend page
When I click the filter Button on the Sport page
