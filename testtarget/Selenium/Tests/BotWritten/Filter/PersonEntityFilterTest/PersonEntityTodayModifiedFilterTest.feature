...
@BotWritten @Filter
Feature: PersonEntity filtered by today's modified Feature

@PersonEntity
Scenario: PersonEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid PersonEntity entities
And I navigate to the PersonEntity backend page
When I click the filter Button on the PersonEntity page
