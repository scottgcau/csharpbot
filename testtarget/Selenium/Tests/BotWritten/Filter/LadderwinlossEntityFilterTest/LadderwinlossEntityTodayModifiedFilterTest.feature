...
@BotWritten @Filter
Feature: LadderwinlossEntity filtered by today's modified Feature

@LadderwinlossEntity
Scenario: LadderwinlossEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid LadderwinlossEntity entities
And I navigate to the LadderwinlossEntity backend page
When I click the filter Button on the LadderwinlossEntity page
