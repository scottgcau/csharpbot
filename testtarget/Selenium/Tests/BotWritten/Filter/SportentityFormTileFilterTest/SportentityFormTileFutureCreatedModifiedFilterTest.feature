...
@BotWritten @Filter
Feature: SportentityFormTile filtered by future's created and modifed and search Feature

@SportentityFormTile
Scenario: SportentityFormTile filtered by future's created and modifed and search
Given I login to the site as a user
Given I have 10 valid SportentityFormTile entities
And I have 1 valid SportentityFormTile entities with fixed string values BlaBla_StringToSearch_BlaBla
And I navigate to the SportentityFormTile backend page
When I click the filter Button on the SportentityFormTile page
