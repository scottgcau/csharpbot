...
@BotWritten @Filter
Feature: SeasonEntity filtered by today's modified Feature

@SeasonEntity
Scenario: SeasonEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid SeasonEntity entities
And I navigate to the SeasonEntity backend page
When I click the filter Button on the SeasonEntity page
