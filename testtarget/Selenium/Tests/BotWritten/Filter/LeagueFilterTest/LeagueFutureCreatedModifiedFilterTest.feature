...
@BotWritten @Filter
Feature: League filtered by future's created and modifed and search Feature

@League
Scenario: League filtered by future's created and modifed and search
Given I login to the site as a user
Given I have 10 valid League entities
And I have 1 valid League entities with fixed string values BlaBla_StringToSearch_BlaBla
And I navigate to the League backend page
When I click the filter Button on the League page
