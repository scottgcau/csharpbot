...
@BotWritten @Filter
Feature: GameEntity filtered by today's modified Feature

@GameEntity
Scenario: GameEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid GameEntity entities
And I navigate to the GameEntity backend page
When I click the filter Button on the GameEntity page
