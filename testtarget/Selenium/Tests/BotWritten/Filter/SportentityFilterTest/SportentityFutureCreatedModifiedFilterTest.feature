...
@BotWritten @Filter
Feature: Sportentity filtered by future's created and modifed and search Feature

@Sportentity
Scenario: Sportentity filtered by future's created and modifed and search
Given I login to the site as a user
Given I have 10 valid Sportentity entities
And I have 1 valid Sportentity entities with fixed string values BlaBla_StringToSearch_BlaBla
And I navigate to the Sportentity backend page
When I click the filter Button on the Sportentity page
