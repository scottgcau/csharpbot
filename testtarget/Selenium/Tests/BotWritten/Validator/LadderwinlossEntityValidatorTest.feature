...
Feature: LadderwinlossEntity Validator

Scenario: Violate LadderwinlossEntity validators
Given I login to the site as a user
And I navigate to the LadderwinlossEntity create page
...
Then I verify the Required Validator for the AwayWon attribute for on-submit validation
Then I verify the Required Validator for the AwayLost attribute for on-submit validation
Then I verify the Required Validator for the AwayFor attribute for on-submit validation
Then I verify the Required Validator for the AwayAgainst attribute for on-submit validation
