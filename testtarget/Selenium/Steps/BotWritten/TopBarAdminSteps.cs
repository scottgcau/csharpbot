...
{
	[Binding]
	public class TopBarAdminStepDefinitions
	{
		private readonly TopBarMenuAdmin _elementsAdminTopBar;
		private readonly ContextConfiguration _contextConfiguration;

		public TopBarAdminStepDefinitions(ContextConfiguration contextConfiguration)
		{
		...
		public void ThenIAssertThatTheAdminBarIsOnTheAdmin(TopbarMenuType topBarMenuText)
		{
			...
			switch (topBarMenuText)
			{
				case TopbarMenuType.ADMIN:
					Assert.Equal($"{_contextConfiguration.BaseUrl}/home", _contextConfiguration.WebDriver.Url);
					break;
				case TopbarMenuType.FRONTEND:
					Assert.Equal($"{_contextConfiguration.BaseUrl}/admin", _contextConfiguration.WebDriver.Url);
					break;
				default:
