...
{
	[Binding]
	public sealed class UserListSteps
	{
		private readonly IWait<IWebDriver> _wait;
		private readonly AllUserPage _allUserPage;
		private readonly ContextConfiguration _contextConfiguration;

		public UserListSteps(ContextConfiguration contextConfiguration)
		{
		...
		public void NavigateToTheAllUserPage()
		{
			...
			WaitUtils.waitForPage(_wait);
		}

		[Then(@"I verify the contents of the All User page")]
		public void VerifyTheContentOfTheAllUserPage()
		{
			_wait.Until(_ =>_allUserPage.CreateNewButton.Displayed);
			_wait.Until(_ =>_allUserPage.ListHeader.Displayed);
			...
			_wait.Until(_ =>_allUserPage.SelectUserTypeModal.Displayed);
			_wait.Until(_ =>_allUserPage.SelectUserTypeDropdown.Displayed);
		}
	}
}