...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class LeagueEntityFormTileEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly LeagueEntityFormTileEntity _leagueEntityFormTileEntity;
		...
		public LeagueEntityFormTileEntityDetailSection(ContextConfiguration contextConfiguration, LeagueEntityFormTileEntity leagueEntityFormTileEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_leagueEntityFormTileEntity = leagueEntityFormTileEntity;
		...
		public void Apply()
		{
			...
			SetTile(_leagueEntityFormTileEntity.Tile);
