...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class TeamEntityFormTileEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly TeamEntityFormTileEntity _teamEntityFormTileEntity;
		...
		public TeamEntityFormTileEntityDetailSection(ContextConfiguration contextConfiguration, TeamEntityFormTileEntity teamEntityFormTileEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_teamEntityFormTileEntity = teamEntityFormTileEntity;
		...
		public void Apply()
		{
			...
			SetTile(_teamEntityFormTileEntity.Tile);
