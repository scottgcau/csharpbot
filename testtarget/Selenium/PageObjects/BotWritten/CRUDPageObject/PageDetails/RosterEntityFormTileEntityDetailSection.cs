...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class RosterEntityFormTileEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly RosterEntityFormTileEntity _rosterEntityFormTileEntity;
		...
		public RosterEntityFormTileEntityDetailSection(ContextConfiguration contextConfiguration, RosterEntityFormTileEntity rosterEntityFormTileEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_rosterEntityFormTileEntity = rosterEntityFormTileEntity;
		...
		public void Apply()
		{
			...
			SetTile(_rosterEntityFormTileEntity.Tile);
