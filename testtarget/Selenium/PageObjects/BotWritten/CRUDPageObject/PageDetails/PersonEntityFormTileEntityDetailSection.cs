...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class PersonEntityFormTileEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly PersonEntityFormTileEntity _personEntityFormTileEntity;
		...
		public PersonEntityFormTileEntityDetailSection(ContextConfiguration contextConfiguration, PersonEntityFormTileEntity personEntityFormTileEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_personEntityFormTileEntity = personEntityFormTileEntity;
		...
		public void Apply()
		{
			...
			SetTile(_personEntityFormTileEntity.Tile);
