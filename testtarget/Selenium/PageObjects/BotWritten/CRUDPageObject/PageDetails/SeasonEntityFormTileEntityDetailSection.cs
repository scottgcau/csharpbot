...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class SeasonEntityFormTileEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly SeasonEntityFormTileEntity _seasonEntityFormTileEntity;
		...
		public SeasonEntityFormTileEntityDetailSection(ContextConfiguration contextConfiguration, SeasonEntityFormTileEntity seasonEntityFormTileEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_seasonEntityFormTileEntity = seasonEntityFormTileEntity;
		...
		public void Apply()
		{
			...
			SetTile(_seasonEntityFormTileEntity.Tile);
