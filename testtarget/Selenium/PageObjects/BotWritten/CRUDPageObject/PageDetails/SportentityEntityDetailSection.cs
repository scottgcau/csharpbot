...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class SportentityEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly SportentityEntity _sportentityEntity;
		...
		public SportentityEntityDetailSection(ContextConfiguration contextConfiguration, SportentityEntity sportentityEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_sportentityEntity = sportentityEntity;
		...
		private By getErrorAttributeSectionAsBy(string attribute)
		{
			return attribute switch
			{
				...
				"SportName" => WebElementUtils.GetElementAsBy(SelectorPathType.CSS, "div.sportname > div > p"),
		...
		public SportentityEntity ExtractEntity()
		{
		...
		public void Apply()
		{
			...
			SetName(_sportentityEntity.Name);
			SetSportname(_sportentityEntity.Sportname);
			SetOrder(_sportentityEntity.Order);
		...
		private void SetSportname (String value)
		{
			...
			SportnameElement.SendKeys(Keys.Escape);
		}
