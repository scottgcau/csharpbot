...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class VenueEntityFormTileEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly VenueEntityFormTileEntity _venueEntityFormTileEntity;
		...
		public VenueEntityFormTileEntityDetailSection(ContextConfiguration contextConfiguration, VenueEntityFormTileEntity venueEntityFormTileEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_venueEntityFormTileEntity = venueEntityFormTileEntity;
		...
		public void Apply()
		{
			...
			SetTile(_venueEntityFormTileEntity.Tile);
