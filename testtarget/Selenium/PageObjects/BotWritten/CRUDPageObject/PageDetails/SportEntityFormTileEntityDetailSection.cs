...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class SportEntityFormTileEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly SportEntityFormTileEntity _sportEntityFormTileEntity;
		...
		public SportEntityFormTileEntityDetailSection(ContextConfiguration contextConfiguration, SportEntityFormTileEntity sportEntityFormTileEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_sportEntityFormTileEntity = sportEntityFormTileEntity;
		...
		public void Apply()
		{
			...
			SetTile(_sportEntityFormTileEntity.Tile);
