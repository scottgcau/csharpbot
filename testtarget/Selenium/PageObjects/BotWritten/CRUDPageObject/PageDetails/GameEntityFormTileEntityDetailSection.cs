...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class GameEntityFormTileEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly GameEntityFormTileEntity _gameEntityFormTileEntity;
		...
		public GameEntityFormTileEntityDetailSection(ContextConfiguration contextConfiguration, GameEntityFormTileEntity gameEntityFormTileEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_gameEntityFormTileEntity = gameEntityFormTileEntity;
		...
		public void Apply()
		{
			...
			SetTile(_gameEntityFormTileEntity.Tile);
