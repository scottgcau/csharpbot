...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class ScheduleEntityFormTileEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly ScheduleEntityFormTileEntity _scheduleEntityFormTileEntity;
		...
		public ScheduleEntityFormTileEntityDetailSection(ContextConfiguration contextConfiguration, ScheduleEntityFormTileEntity scheduleEntityFormTileEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_scheduleEntityFormTileEntity = scheduleEntityFormTileEntity;
		...
		public void Apply()
		{
			...
			SetTile(_scheduleEntityFormTileEntity.Tile);
