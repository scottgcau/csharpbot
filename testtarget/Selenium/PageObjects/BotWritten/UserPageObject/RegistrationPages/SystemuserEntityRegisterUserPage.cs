...
{
	public class RegisterSystemuserEntityUserPage : RegisterUserBasePage
	{
		public override string Url => baseUrl + "/login";

		public RegisterSystemuserEntityUserPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
