...
namespace Sportstats
{
	public class Startup
	{
		...
		private void ConfigureGraphql(IServiceCollection services)
		{
			...
			services.TryAddSingleton<LadderEntityType>();
			services.TryAddSingleton<LadderEntityInputType>();
			services.TryAddSingleton<ScheduleEntityType>();
			services.TryAddSingleton<ScheduleEntityInputType>();
			services.TryAddSingleton<LaddereliminationEntityType>();
			services.TryAddSingleton<LaddereliminationEntityInputType>();
			services.TryAddSingleton<LadderwinlossEntityType>();
			services.TryAddSingleton<LadderwinlossEntityInputType>();
			services.TryAddSingleton<RoundEntityType>();
			services.TryAddSingleton<RoundEntityInputType>();
			services.TryAddSingleton<GameEntityType>();
			services.TryAddSingleton<GameEntityInputType>();
			services.TryAddSingleton<DivisionEntityType>();
			services.TryAddSingleton<DivisionEntityInputType>();
			...
			services.TryAddSingleton<GamerefereeEntityType>();
			services.TryAddSingleton<GamerefereeEntityInputType>();
			...
			services.TryAddSingleton<SystemuserEntityType>();
			services.TryAddSingleton<SystemuserEntityInputType>();
			services.TryAddSingleton<SystemuserEntityCreateInputType>();
			...
			services.TryAddSingleton<EnumerationGraphType<Laddertype>>();
			...
			GraphTypeTypeRegistry.Register<LadderEntity, LadderEntityType>();
			GraphTypeTypeRegistry.Register<ScheduleEntity, ScheduleEntityType>();
			GraphTypeTypeRegistry.Register<LaddereliminationEntity, LaddereliminationEntityType>();
			GraphTypeTypeRegistry.Register<LadderwinlossEntity, LadderwinlossEntityType>();
			GraphTypeTypeRegistry.Register<RoundEntity, RoundEntityType>();
			GraphTypeTypeRegistry.Register<GameEntity, GameEntityType>();
			GraphTypeTypeRegistry.Register<DivisionEntity, DivisionEntityType>();
			GraphTypeTypeRegistry.Register<VenueEntity, VenueEntityType>();
			GraphTypeTypeRegistry.Register<TeamEntity, TeamEntityType>();
			GraphTypeTypeRegistry.Register<GamerefereeEntity, GamerefereeEntityType>();
			GraphTypeTypeRegistry.Register<SeasonEntity, SeasonEntityType>();
			GraphTypeTypeRegistry.Register<PersonEntity, PersonEntityType>();
			GraphTypeTypeRegistry.Register<SystemuserEntity, SystemuserEntityType>();
