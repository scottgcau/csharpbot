...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class GamerefereeEntityType : EfObjectGraphType<SportstatsDBContext, GamerefereeEntity>
	{
		public GamerefereeEntityType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			Description = @"Game referee entity";

			// Add model fields to type
			Field(o => o.Id, type: typeof(IdGraphType));
			Field(o => o.Created, type: typeof(DateTimeGraphType));
			Field(o => o.Modified, type: typeof(DateTimeGraphType));
			Field(o => o.Headreferee, type: typeof(BooleanGraphType));
	...
	/// </summary>
	public class GamerefereeEntityInputType : InputObjectGraphType<GamerefereeEntity>
	{
		public GamerefereeEntityInputType()
		{
			Name = "GamerefereeEntityInput";
			Description = "The input object for adding a new GamerefereeEntity";

			// Add entity fields
			Field<IdGraphType>("Id");
			Field<DateTimeGraphType>("Created");
			Field<DateTimeGraphType>("Modified");
			Field<BooleanGraphType>("Headreferee");
