...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class VenueSubmissionEntityDto : ModelDto<VenueSubmissionEntity>
	{
		...
		public VenueSubmissionEntityDto()
		{
		...
		public override VenueSubmissionEntity ToModel()
		{
		...
		public override ModelDto<VenueSubmissionEntity> LoadModelData(VenueSubmissionEntity model)
		{
			Id = model.Id;
