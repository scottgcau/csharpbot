...
namespace Sportstats.Models {
	...
	[Table("LeagueSubmission")]
	// % protected region % [Configure entity attributes here] end
	public class LeagueSubmissionEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("FormVersion", "FormSubmissions", false, typeof(LeagueEntityFormVersion))]
		public LeagueEntityFormVersion FormVersion { get; set; }
		...
		{
			var modelList = models.Cast<LeagueSubmissionEntity>().ToList();
