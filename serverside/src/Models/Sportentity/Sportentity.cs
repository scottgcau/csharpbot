...
namespace Sportstats.Models {
	...
	/// SportDesc
	/// </summary>
	public class Sportentity : IOwnerAbstractModel
	{
		[Key]
		...
		/// </summary>
		/// <see cref="Sportstats.Models.SportentityFormTile"/>
		[EntityForeignKey("FormPages", "Form", false, typeof(SportentityFormTile))]
		public ICollection<SportentityFormTile> FormPages { get; set; }
