...
namespace Sportstats.Models
{
	...
	public class SportentityFormVersionType : EfObjectGraphType<SportstatsDBContext, SportentityFormVersion>
	{
		...
		{
			Description = @"The form versions for the SportEntity form behaviour";
			...
			IEnumerable<SportentitySubmission> FormSubmissionsResolveFunction(ResolveFieldContext<SportentityFormVersion> context)
			{
				var graphQlContext = (SportstatsGraphQlContext) context.UserContext;
				var filter = SecurityService.CreateReadSecurityFilter<SportentitySubmission>(
	...
	/// </summary>
	public class SportentityFormVersionInputType : InputObjectGraphType
	{
		public SportentityFormVersionInputType()
		{
			...
			Field<ListGraphType<SportentitySubmissionInputType>>("FormSubmissions").Description = @"The submissions for this form version";
