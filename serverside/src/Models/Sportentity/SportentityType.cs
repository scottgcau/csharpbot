...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class SportentityType : EfObjectGraphType<SportstatsDBContext, Sportentity>
	{
		public SportentityType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			...
			// GraphQL reference to entity SportentityFormTile via reference FormPage
			IEnumerable<SportentityFormTile> FormPagesResolveFunction(ResolveFieldContext<Sportentity> context)
			{
				var graphQlContext = (SportstatsGraphQlContext) context.UserContext;
				var filter = SecurityService.CreateReadSecurityFilter<SportentityFormTile>(graphQlContext.IdentityService, graphQlContext.UserManager, graphQlContext.DbContext);
				return context.Source.FormPages.Where(filter.Compile());
			}
			AddNavigationListField("FormPages", (Func<ResolveFieldContext<Sportentity>, IEnumerable<SportentityFormTile>>) FormPagesResolveFunction);
	...
	/// </summary>
	public class SportentityInputType : InputObjectGraphType
	{
		public SportentityInputType()
		{
			Name = "SportentityInput";
			Description = "The input object for adding a new Sportentity";
			...
			Field<ListGraphType<SportentityFormTileInputType>>("FormPages");
