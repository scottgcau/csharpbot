...
namespace Sportstats.Models {
	...
	[Table("RosterSubmission")]
	// % protected region % [Configure entity attributes here] end
	public class RosterSubmissionEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("FormVersion", "FormSubmissions", false, typeof(RosterEntityFormVersion))]
		public RosterEntityFormVersion FormVersion { get; set; }
		...
		{
			var modelList = models.Cast<RosterSubmissionEntity>().ToList();
