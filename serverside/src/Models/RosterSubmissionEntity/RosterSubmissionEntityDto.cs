...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class RosterSubmissionEntityDto : ModelDto<RosterSubmissionEntity>
	{
		...
		public RosterSubmissionEntityDto()
		{
		...
		public override RosterSubmissionEntity ToModel()
		{
		...
		public override ModelDto<RosterSubmissionEntity> LoadModelData(RosterSubmissionEntity model)
		{
			Id = model.Id;
