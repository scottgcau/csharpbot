...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class SportEntityFormVersionType : EfObjectGraphType<SportstatsDBContext, SportEntityFormVersion>
	{
		public SportEntityFormVersionType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			Description = @"The form versions for the Sport Entity form behaviour";
			...
			IEnumerable<SportSubmissionEntity> FormSubmissionsResolveFunction(ResolveFieldContext<SportEntityFormVersion> context)
			{
				var graphQlContext = (SportstatsGraphQlContext) context.UserContext;
				var filter = SecurityService.CreateReadSecurityFilter<SportSubmissionEntity>(
	...
	/// </summary>
	public class SportEntityFormVersionInputType : InputObjectGraphType<SportEntityFormVersion>
	{
		public SportEntityFormVersionInputType()
		{
			Name = "SportEntityFormVersionInput";
			Description = "The input object for adding a new SportEntityFormVersion";
			...
			Field<ListGraphType<SportSubmissionEntityInputType>>("FormSubmissions").Description = @"The submissions for this form version";
