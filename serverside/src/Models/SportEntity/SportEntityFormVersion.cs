...
namespace Sportstats.Models {
	/// <summary>
	/// The form versions for the Sport Entity form behaviour
	/// </summary>
	// % protected region % [Configure entity attributes here] off begin
	[Table("SportEntityFormVersion")]
	...
	public class SportEntityFormVersion : IOwnerAbstractModel	{
		...
		/// </summary>
		/// <see cref="Sportstats.Models.SportSubmissionEntity"/>
		[EntityForeignKey("FormSubmissions", "FormVersion", false, typeof(SportSubmissionEntity))]
		public ICollection<SportSubmissionEntity> FormSubmissions { get; set; }
		...
		{
			var modelList = models.Cast<SportEntityFormVersion>().ToList();
