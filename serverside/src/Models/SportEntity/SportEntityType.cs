...
namespace Sportstats.Models
{
	...
	public class SportEntityType : EfObjectGraphType<SportstatsDBContext, SportEntity>
	{
		public SportEntityType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			...
			IEnumerable<LeagueEntity> LeaguessResolveFunction(ResolveFieldContext<SportEntity> context)
			{
				...
				var filter = SecurityService.CreateReadSecurityFilter<LeagueEntity>(graphQlContext.IdentityService, graphQlContext.UserManager, graphQlContext.DbContext, graphQlContext.ServiceProvider);
	...
	/// </summary>
	public class SportEntityInputType : InputObjectGraphType<SportEntity>
	{
