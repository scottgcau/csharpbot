...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class RosterEntityFormTileEntityType : EfObjectGraphType<SportstatsDBContext, RosterEntityFormTileEntity>
	{
		public RosterEntityFormTileEntityType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			...
			// GraphQL reference to entity RosterEntity via reference Form
	...
	/// </summary>
	public class RosterEntityFormTileEntityInputType : InputObjectGraphType<RosterEntityFormTileEntity>
	{
		public RosterEntityFormTileEntityInputType()
		{
			Name = "RosterEntityFormTileEntityInput";
			Description = "The input object for adding a new RosterEntityFormTileEntity";
			...
			Field<RosterEntityInputType>("Form");
