...
namespace Sportstats.Models {
	...
	[Table("RosterEntityFormTile")]
	// % protected region % [Configure entity attributes here] end
	public class RosterEntityFormTileEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("Form", "FormPages", true, typeof(RosterEntity))]
		...
		{
			var modelList = models.Cast<RosterEntityFormTileEntity>().ToList();
