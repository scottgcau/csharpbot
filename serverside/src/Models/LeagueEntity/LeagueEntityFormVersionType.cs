...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class LeagueEntityFormVersionType : EfObjectGraphType<SportstatsDBContext, LeagueEntityFormVersion>
	{
		public LeagueEntityFormVersionType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			Description = @"The form versions for the League Entity form behaviour";
			...
			IEnumerable<LeagueSubmissionEntity> FormSubmissionsResolveFunction(ResolveFieldContext<LeagueEntityFormVersion> context)
			{
				var graphQlContext = (SportstatsGraphQlContext) context.UserContext;
				var filter = SecurityService.CreateReadSecurityFilter<LeagueSubmissionEntity>(
	...
	/// </summary>
	public class LeagueEntityFormVersionInputType : InputObjectGraphType<LeagueEntityFormVersion>
	{
		public LeagueEntityFormVersionInputType()
		{
			Name = "LeagueEntityFormVersionInput";
			Description = "The input object for adding a new LeagueEntityFormVersion";
			...
			Field<ListGraphType<LeagueSubmissionEntityInputType>>("FormSubmissions").Description = @"The submissions for this form version";
