...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class ScheduleEntityFormVersionType : EfObjectGraphType<SportstatsDBContext, ScheduleEntityFormVersion>
	{
		public ScheduleEntityFormVersionType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			Description = @"The form versions for the Schedule Entity form behaviour";
			...
			IEnumerable<ScheduleSubmissionEntity> FormSubmissionsResolveFunction(ResolveFieldContext<ScheduleEntityFormVersion> context)
			{
				var graphQlContext = (SportstatsGraphQlContext) context.UserContext;
				var filter = SecurityService.CreateReadSecurityFilter<ScheduleSubmissionEntity>(
	...
	/// </summary>
	public class ScheduleEntityFormVersionInputType : InputObjectGraphType<ScheduleEntityFormVersion>
	{
		public ScheduleEntityFormVersionInputType()
		{
			Name = "ScheduleEntityFormVersionInput";
			Description = "The input object for adding a new ScheduleEntityFormVersion";
			...
			Field<ListGraphType<ScheduleSubmissionEntityInputType>>("FormSubmissions").Description = @"The submissions for this form version";
