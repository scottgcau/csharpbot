...
namespace Sportstats.Models {
	...
	[Table("GameSubmission")]
	// % protected region % [Configure entity attributes here] end
	public class GameSubmissionEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("FormVersion", "FormSubmissions", false, typeof(GameEntityFormVersion))]
		public GameEntityFormVersion FormVersion { get; set; }
		...
		{
			var modelList = models.Cast<GameSubmissionEntity>().ToList();
