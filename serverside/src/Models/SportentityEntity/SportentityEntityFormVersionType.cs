...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class SportentityEntityFormVersionType : EfObjectGraphType<SportstatsDBContext, SportentityEntityFormVersion>
	{
		public SportentityEntityFormVersionType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			Description = @"The form versions for the SportEntity Entity form behaviour";
			...
			IEnumerable<SportentitySubmissionEntity> FormSubmissionsResolveFunction(ResolveFieldContext<SportentityEntityFormVersion> context)
			{
				var graphQlContext = (SportstatsGraphQlContext) context.UserContext;
				var filter = SecurityService.CreateReadSecurityFilter<SportentitySubmissionEntity>(
	...
	/// </summary>
	public class SportentityEntityFormVersionInputType : InputObjectGraphType
	{
		public SportentityEntityFormVersionInputType()
		{
			Name = "SportentityEntityFormVersionInput";
			Description = "The input object for adding a new SportentityEntityFormVersion";
			...
			Field<ListGraphType<SportentitySubmissionEntityInputType>>("FormSubmissions").Description = @"The submissions for this form version";
