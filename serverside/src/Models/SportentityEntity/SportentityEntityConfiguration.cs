...
namespace Sportstats.Models {
	public class SportentityEntityConfiguration : IEntityTypeConfiguration<SportentityEntity>
	{
		public void Configure(EntityTypeBuilder<SportentityEntity> builder)
		{
			...
			builder.HasIndex(e => e.Sportname);
