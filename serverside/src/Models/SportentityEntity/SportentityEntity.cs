...
namespace Sportstats.Models {
	...
	public class SportentityEntity : IOwnerAbstractModel
	{
		[Key]
		...
		/// </summary>
		/// <see cref="Sportstats.Models.SportentityEntityFormVersion"/>
		[EntityForeignKey("FormVersions", "Form", false, typeof(SportentityEntityFormVersion))]
		public ICollection<SportentityEntityFormVersion> FormVersions { get; set; }
		...
		[EntityForeignKey("PublishedVersion", "PublishedForm", false, typeof(SportentityEntityFormVersion))]
		public SportentityEntityFormVersion PublishedVersion { get; set; }

		/// <summary>
		/// Incoming one to many reference
		/// </summary>
		/// <see cref="Sportstats.Models.SportentityEntityFormTileEntity"/>
		[EntityForeignKey("FormPages", "Form", false, typeof(SportentityEntityFormTileEntity))]
		public ICollection<SportentityEntityFormTileEntity> FormPages { get; set; }
