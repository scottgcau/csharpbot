...
namespace Sportstats.Models {
	public class DivisionEntityConfiguration : IEntityTypeConfiguration<DivisionEntity>
	{
		public void Configure(EntityTypeBuilder<DivisionEntity> builder)
		{
			AbstractModelConfiguration.Configure(builder);

			// % protected region % [Override Teamss Division configuration here] off begin
			builder
				.HasMany(e => e.Teamss)
				.WithOne(e => e.Division)
				.OnDelete(DeleteBehavior.Restrict);
			// % protected region % [Override Teamss Division configuration here] end

			// % protected region % [Override Season Divisionss configuration here] off begin
			builder
				.HasOne(e => e.Season)
				.WithMany(e => e.Divisionss)
				.OnDelete(DeleteBehavior.Cascade);
			// % protected region % [Override Season Divisionss configuration here] end
