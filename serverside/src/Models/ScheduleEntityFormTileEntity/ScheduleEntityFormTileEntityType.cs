...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class ScheduleEntityFormTileEntityType : EfObjectGraphType<SportstatsDBContext, ScheduleEntityFormTileEntity>
	{
		public ScheduleEntityFormTileEntityType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			...
			// GraphQL reference to entity ScheduleEntity via reference Form
	...
	/// </summary>
	public class ScheduleEntityFormTileEntityInputType : InputObjectGraphType<ScheduleEntityFormTileEntity>
	{
		public ScheduleEntityFormTileEntityInputType()
		{
			Name = "ScheduleEntityFormTileEntityInput";
			Description = "The input object for adding a new ScheduleEntityFormTileEntity";
			...
			Field<ScheduleEntityInputType>("Form");
