...
namespace Sportstats.Models {
	...
	[Table("ScheduleEntityFormTile")]
	// % protected region % [Configure entity attributes here] end
	public class ScheduleEntityFormTileEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("Form", "FormPages", true, typeof(ScheduleEntity))]
		...
		{
			var modelList = models.Cast<ScheduleEntityFormTileEntity>().ToList();
