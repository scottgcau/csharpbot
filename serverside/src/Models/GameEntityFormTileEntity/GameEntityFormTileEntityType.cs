...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class GameEntityFormTileEntityType : EfObjectGraphType<SportstatsDBContext, GameEntityFormTileEntity>
	{
		public GameEntityFormTileEntityType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			...
			// GraphQL reference to entity GameEntity via reference Form
	...
	/// </summary>
	public class GameEntityFormTileEntityInputType : InputObjectGraphType<GameEntityFormTileEntity>
	{
		public GameEntityFormTileEntityInputType()
		{
			Name = "GameEntityFormTileEntityInput";
			Description = "The input object for adding a new GameEntityFormTileEntity";
			...
			Field<GameEntityInputType>("Form");
