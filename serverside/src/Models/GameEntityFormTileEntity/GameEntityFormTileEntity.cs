...
namespace Sportstats.Models {
	...
	[Table("GameEntityFormTile")]
	// % protected region % [Configure entity attributes here] end
	public class GameEntityFormTileEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("Form", "FormPages", true, typeof(GameEntity))]
		...
		{
			var modelList = models.Cast<GameEntityFormTileEntity>().ToList();
