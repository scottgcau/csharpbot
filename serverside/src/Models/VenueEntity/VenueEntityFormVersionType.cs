...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class VenueEntityFormVersionType : EfObjectGraphType<SportstatsDBContext, VenueEntityFormVersion>
	{
		public VenueEntityFormVersionType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			Description = @"The form versions for the Venue Entity form behaviour";
			...
			IEnumerable<VenueSubmissionEntity> FormSubmissionsResolveFunction(ResolveFieldContext<VenueEntityFormVersion> context)
			{
				var graphQlContext = (SportstatsGraphQlContext) context.UserContext;
				var filter = SecurityService.CreateReadSecurityFilter<VenueSubmissionEntity>(
	...
	/// </summary>
	public class VenueEntityFormVersionInputType : InputObjectGraphType<VenueEntityFormVersion>
	{
		public VenueEntityFormVersionInputType()
		{
			Name = "VenueEntityFormVersionInput";
			Description = "The input object for adding a new VenueEntityFormVersion";
			...
			Field<ListGraphType<VenueSubmissionEntityInputType>>("FormSubmissions").Description = @"The submissions for this form version";
