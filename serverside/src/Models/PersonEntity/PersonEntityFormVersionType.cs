...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class PersonEntityFormVersionType : EfObjectGraphType<SportstatsDBContext, PersonEntityFormVersion>
	{
		public PersonEntityFormVersionType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			Description = @"The form versions for the Person Entity form behaviour";
			...
			IEnumerable<PersonSubmissionEntity> FormSubmissionsResolveFunction(ResolveFieldContext<PersonEntityFormVersion> context)
			{
				var graphQlContext = (SportstatsGraphQlContext) context.UserContext;
				var filter = SecurityService.CreateReadSecurityFilter<PersonSubmissionEntity>(
	...
	/// </summary>
	public class PersonEntityFormVersionInputType : InputObjectGraphType<PersonEntityFormVersion>
	{
		public PersonEntityFormVersionInputType()
		{
			Name = "PersonEntityFormVersionInput";
			Description = "The input object for adding a new PersonEntityFormVersion";
			...
			Field<ListGraphType<PersonSubmissionEntityInputType>>("FormSubmissions").Description = @"The submissions for this form version";
