...
namespace Sportstats.Models {
	...
	public class TeamSubmissionEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("FormVersion", "FormSubmissions", false, typeof(TeamEntityFormVersion))]
		public TeamEntityFormVersion FormVersion { get; set; }
		...
		{
			var modelList = models.Cast<TeamSubmissionEntity>().ToList();
