...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class SportEntityFormTileEntityType : EfObjectGraphType<SportstatsDBContext, SportEntityFormTileEntity>
	{
		public SportEntityFormTileEntityType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
	...
	/// </summary>
	public class SportEntityFormTileEntityInputType : InputObjectGraphType<SportEntityFormTileEntity>
	{
		public SportEntityFormTileEntityInputType()
		{
			Name = "SportEntityFormTileEntityInput";
			Description = "The input object for adding a new SportEntityFormTileEntity";
