...
namespace Sportstats.Models {
	...
	[Table("SportEntityFormTile")]
	// % protected region % [Configure entity attributes here] end
	public class SportEntityFormTileEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("Form", "FormPages", true, typeof(SportEntity))]
		...
		{
			var modelList = models.Cast<SportEntityFormTileEntity>().ToList();
