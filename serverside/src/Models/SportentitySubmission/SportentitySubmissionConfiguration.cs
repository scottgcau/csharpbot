...
namespace Sportstats.Models {
	public class SportentitySubmissionConfiguration : IEntityTypeConfiguration<SportentitySubmission>
	{
		public void Configure(EntityTypeBuilder<SportentitySubmission> builder)
		{
