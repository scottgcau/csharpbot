...
namespace Sportstats.Models {
	...
	[Table("SportentitySubmission")]
	// % protected region % [Configure entity attributes here] end
	public class SportentitySubmissionEntity : IOwnerAbstractModel
	{
		[Key]
		...
		[EntityForeignKey("FormVersion", "FormSubmissions", false, typeof(SportentityEntityFormVersion))]
		public SportentityEntityFormVersion FormVersion { get; set; }
