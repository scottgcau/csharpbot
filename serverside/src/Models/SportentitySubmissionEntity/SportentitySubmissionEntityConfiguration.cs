...
namespace Sportstats.Models {
	public class SportentitySubmissionEntityConfiguration : IEntityTypeConfiguration<SportentitySubmissionEntity>
	{
		public void Configure(EntityTypeBuilder<SportentitySubmissionEntity> builder)
		{
