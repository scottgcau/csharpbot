...
namespace Sportstats.Models {
	...
	[Table("SportSubmission")]
	// % protected region % [Configure entity attributes here] end
	public class SportSubmissionEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("FormVersion", "FormSubmissions", false, typeof(SportEntityFormVersion))]
		public SportEntityFormVersion FormVersion { get; set; }
		...
		{
			var modelList = models.Cast<SportSubmissionEntity>().ToList();
