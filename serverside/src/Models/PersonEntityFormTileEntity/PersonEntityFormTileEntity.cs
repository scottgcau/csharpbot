...
namespace Sportstats.Models {
	...
	[Table("PersonEntityFormTile")]
	// % protected region % [Configure entity attributes here] end
	public class PersonEntityFormTileEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("Form", "FormPages", true, typeof(PersonEntity))]
		...
		{
			var modelList = models.Cast<PersonEntityFormTileEntity>().ToList();
