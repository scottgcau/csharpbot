...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class PersonEntityFormTileEntityType : EfObjectGraphType<SportstatsDBContext, PersonEntityFormTileEntity>
	{
		public PersonEntityFormTileEntityType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			...
			// GraphQL reference to entity PersonEntity via reference Form
	...
	/// </summary>
	public class PersonEntityFormTileEntityInputType : InputObjectGraphType<PersonEntityFormTileEntity>
	{
		public PersonEntityFormTileEntityInputType()
		{
			Name = "PersonEntityFormTileEntityInput";
			Description = "The input object for adding a new PersonEntityFormTileEntity";
			...
			Field<PersonEntityInputType>("Form");
