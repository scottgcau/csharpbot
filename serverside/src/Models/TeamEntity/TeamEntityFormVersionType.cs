...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class TeamEntityFormVersionType : EfObjectGraphType<SportstatsDBContext, TeamEntityFormVersion>
	{
		public TeamEntityFormVersionType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			Description = @"The form versions for the Team Entity form behaviour";
			...
			IEnumerable<TeamSubmissionEntity> FormSubmissionsResolveFunction(ResolveFieldContext<TeamEntityFormVersion> context)
			{
				var graphQlContext = (SportstatsGraphQlContext) context.UserContext;
				var filter = SecurityService.CreateReadSecurityFilter<TeamSubmissionEntity>(
	...
	/// </summary>
	public class TeamEntityFormVersionInputType : InputObjectGraphType<TeamEntityFormVersion>
	{
		public TeamEntityFormVersionInputType()
		{
			Name = "TeamEntityFormVersionInput";
			Description = "The input object for adding a new TeamEntityFormVersion";
			...
			Field<ListGraphType<TeamSubmissionEntityInputType>>("FormSubmissions").Description = @"The submissions for this form version";
