...
namespace Sportstats.Models {
	...
	public class LadderwinlossEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("Team", "Ladderwinlossess", false, typeof(TeamEntity))]
		...
		[EntityForeignKey("Ladder", "Ladderwinlossess", false, typeof(LadderEntity))]
		...
		{
			var modelList = models.Cast<LadderwinlossEntity>().ToList();
