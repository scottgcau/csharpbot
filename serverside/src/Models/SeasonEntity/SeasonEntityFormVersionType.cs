...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class SeasonEntityFormVersionType : EfObjectGraphType<SportstatsDBContext, SeasonEntityFormVersion>
	{
		public SeasonEntityFormVersionType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			Description = @"The form versions for the Season Entity form behaviour";
			...
			IEnumerable<SeasonSubmissionEntity> FormSubmissionsResolveFunction(ResolveFieldContext<SeasonEntityFormVersion> context)
			{
				var graphQlContext = (SportstatsGraphQlContext) context.UserContext;
				var filter = SecurityService.CreateReadSecurityFilter<SeasonSubmissionEntity>(
	...
	/// </summary>
	public class SeasonEntityFormVersionInputType : InputObjectGraphType<SeasonEntityFormVersion>
	{
		public SeasonEntityFormVersionInputType()
		{
			Name = "SeasonEntityFormVersionInput";
			Description = "The input object for adding a new SeasonEntityFormVersion";
			...
			Field<ListGraphType<SeasonSubmissionEntityInputType>>("FormSubmissions").Description = @"The submissions for this form version";
