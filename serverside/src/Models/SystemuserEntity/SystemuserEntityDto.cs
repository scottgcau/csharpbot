...
namespace Sportstats.Models
{
	...
	/// System users
	/// </summary>
	public class SystemuserEntityDto : ModelDto<SystemuserEntity>
	{
		...
		public override ModelDto<SystemuserEntity> LoadModelData(SystemuserEntity model)
		{
			Id = model.Id;
