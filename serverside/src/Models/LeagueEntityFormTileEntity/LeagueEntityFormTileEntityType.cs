...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class LeagueEntityFormTileEntityType : EfObjectGraphType<SportstatsDBContext, LeagueEntityFormTileEntity>
	{
		public LeagueEntityFormTileEntityType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			...
			// GraphQL reference to entity LeagueEntity via reference Form
	...
	/// </summary>
	public class LeagueEntityFormTileEntityInputType : InputObjectGraphType<LeagueEntityFormTileEntity>
	{
		public LeagueEntityFormTileEntityInputType()
		{
			Name = "LeagueEntityFormTileEntityInput";
			Description = "The input object for adding a new LeagueEntityFormTileEntity";
			...
			Field<LeagueEntityInputType>("Form");
