...
namespace Sportstats.Models {
	...
	[Table("LeagueEntityFormTile")]
	// % protected region % [Configure entity attributes here] end
	public class LeagueEntityFormTileEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("Form", "FormPages", true, typeof(LeagueEntity))]
		...
		{
			var modelList = models.Cast<LeagueEntityFormTileEntity>().ToList();
