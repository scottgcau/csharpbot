...
namespace Sportstats.Models {
	public class RosterTimelineEventsEntityConfiguration : IEntityTypeConfiguration<RosterTimelineEventsEntity>
	{
		public void Configure(EntityTypeBuilder<RosterTimelineEventsEntity> builder)
		{
