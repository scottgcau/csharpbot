...
namespace Sportstats.Models {
	...
	[Table("RosterTimelineEvents")]
	// % protected region % [Configure entity attributes here] end
	public class RosterTimelineEventsEntity : IOwnerAbstractModel, ITimelineEventEntity 	{
		[Key]
		...
		[EntityForeignKey("Entity", "LoggedEvents", false, typeof(RosterEntity))]
		public RosterEntity Entity { get; set; }
		...
		{
			var modelList = models.Cast<RosterTimelineEventsEntity>().ToList();
