...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class RosterEntityFormVersionType : EfObjectGraphType<SportstatsDBContext, RosterEntityFormVersion>
	{
		public RosterEntityFormVersionType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			Description = @"The form versions for the Roster Entity form behaviour";
			...
			IEnumerable<RosterSubmissionEntity> FormSubmissionsResolveFunction(ResolveFieldContext<RosterEntityFormVersion> context)
			{
				var graphQlContext = (SportstatsGraphQlContext) context.UserContext;
				var filter = SecurityService.CreateReadSecurityFilter<RosterSubmissionEntity>(
	...
	/// </summary>
	public class RosterEntityFormVersionInputType : InputObjectGraphType<RosterEntityFormVersion>
	{
		public RosterEntityFormVersionInputType()
		{
			Name = "RosterEntityFormVersionInput";
			Description = "The input object for adding a new RosterEntityFormVersion";
			...
			Field<ListGraphType<RosterSubmissionEntityInputType>>("FormSubmissions").Description = @"The submissions for this form version";
