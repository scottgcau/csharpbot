...
namespace Sportstats.Models {
	...
	public class PersonSubmissionEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("FormVersion", "FormSubmissions", false, typeof(PersonEntityFormVersion))]
		public PersonEntityFormVersion FormVersion { get; set; }
		...
		{
			var modelList = models.Cast<PersonSubmissionEntity>().ToList();
