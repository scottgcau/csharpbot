...
namespace Sportstats.Models {
	public class RosterassignmentEntityConfiguration : IEntityTypeConfiguration<RosterassignmentEntity>
	{
		public void Configure(EntityTypeBuilder<RosterassignmentEntity> builder)
		{
