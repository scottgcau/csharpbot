...
namespace Sportstats.Models {
	...
	public class RosterassignmentEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("Roster", "Rosterassignmentss", false, typeof(RosterEntity))]
		...
		{
			var modelList = models.Cast<RosterassignmentEntity>().ToList();
