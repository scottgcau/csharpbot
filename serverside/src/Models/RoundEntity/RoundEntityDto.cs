...
namespace Sportstats.Models
{
	...
	/// Round entity
	/// </summary>
	public class RoundEntityDto : ModelDto<RoundEntity>
	{
		...
		public override RoundEntity ToModel()
		{
		...
		public override ModelDto<RoundEntity> LoadModelData(RoundEntity model)
		{
			Id = model.Id;
