...
namespace Sportstats.Models
{
	...
	/// Ladder entity
	/// </summary>
	public class LadderEntityDto : ModelDto<LadderEntity>
	{
		...
		public override LadderEntity ToModel()
		{
		...
		public override ModelDto<LadderEntity> LoadModelData(LadderEntity model)
		{
			Id = model.Id;
