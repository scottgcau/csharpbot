...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class LadderEntityType : EfObjectGraphType<SportstatsDBContext, LadderEntity>
	{
		public LadderEntityType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			Description = @"Ladder entity";

			// Add model fields to type
			Field(o => o.Id, type: typeof(IdGraphType));
			Field(o => o.Created, type: typeof(DateTimeGraphType));
			Field(o => o.Modified, type: typeof(DateTimeGraphType));
			Field(o => o.Laddertype, type: typeof(EnumerationGraphType<Laddertype>)).Description(@"Type of ladder");
			...
			IEnumerable<LadderwinlossEntity> LadderwinlossessResolveFunction(ResolveFieldContext<LadderEntity> context)
			{
			...
			AddNavigationListField("Ladderwinlossess", (Func<ResolveFieldContext<LadderEntity>, IEnumerable<LadderwinlossEntity>>) LadderwinlossessResolveFunction);
			...
			IEnumerable<LaddereliminationEntity> LaddereliminationssResolveFunction(ResolveFieldContext<LadderEntity> context)
			{
				var graphQlContext = (SportstatsGraphQlContext) context.UserContext;
			...
			AddNavigationListField("Laddereliminationss", (Func<ResolveFieldContext<LadderEntity>, IEnumerable<LaddereliminationEntity>>) LaddereliminationssResolveFunction);
	...
	/// </summary>
	public class LadderEntityInputType : InputObjectGraphType<LadderEntity>
	{
		public LadderEntityInputType()
		{
			Name = "LadderEntityInput";
			Description = "The input object for adding a new LadderEntity";

			// Add entity fields
			Field<IdGraphType>("Id");
			Field<DateTimeGraphType>("Created");
			Field<DateTimeGraphType>("Modified");
			Field<EnumerationGraphType<Laddertype>>("Laddertype").Description = @"Type of ladder";
