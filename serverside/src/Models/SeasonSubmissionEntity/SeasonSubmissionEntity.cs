...
namespace Sportstats.Models {
	...
	[Table("SeasonSubmission")]
	// % protected region % [Configure entity attributes here] end
	public class SeasonSubmissionEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("FormVersion", "FormSubmissions", false, typeof(SeasonEntityFormVersion))]
		public SeasonEntityFormVersion FormVersion { get; set; }
		...
		{
			var modelList = models.Cast<SeasonSubmissionEntity>().ToList();
