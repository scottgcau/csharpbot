...
namespace Sportstats.Models {
	...
	[Table("SeasonEntityFormTile")]
	// % protected region % [Configure entity attributes here] end
	public class SeasonEntityFormTileEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("Form", "FormPages", true, typeof(SeasonEntity))]
		...
		{
			var modelList = models.Cast<SeasonEntityFormTileEntity>().ToList();
