...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class SeasonEntityFormTileEntityType : EfObjectGraphType<SportstatsDBContext, SeasonEntityFormTileEntity>
	{
		public SeasonEntityFormTileEntityType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			...
			// GraphQL reference to entity SeasonEntity via reference Form
	...
	/// </summary>
	public class SeasonEntityFormTileEntityInputType : InputObjectGraphType<SeasonEntityFormTileEntity>
	{
		public SeasonEntityFormTileEntityInputType()
		{
			Name = "SeasonEntityFormTileEntityInput";
			Description = "The input object for adding a new SeasonEntityFormTileEntity";
			...
			Field<SeasonEntityInputType>("Form");
