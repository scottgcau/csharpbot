...
namespace Sportstats.Models {
	...
	[Table("SportentityEntityFormTile")]
	// % protected region % [Configure entity attributes here] end
	public class SportentityEntityFormTileEntity : IOwnerAbstractModel
	{
		[Key]
		...
		public SportentityEntityFormTileEntity() 
		{
		...
		[EntityForeignKey("Form", "FormPages", true, typeof(SportentityEntity))]
