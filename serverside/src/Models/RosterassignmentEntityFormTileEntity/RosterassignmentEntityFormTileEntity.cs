...
namespace Sportstats.Models {
	...
	[Table("RosterassignmentEntityFormTile")]
	// % protected region % [Configure entity attributes here] end
	public class RosterassignmentEntityFormTileEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("Form", "FormPages", true, typeof(RosterassignmentEntity))]
		...
		{
			var modelList = models.Cast<RosterassignmentEntityFormTileEntity>().ToList();
