...
namespace Sportstats.Models {
	...
	[Table("VenueEntityFormTile")]
	// % protected region % [Configure entity attributes here] end
	public class VenueEntityFormTileEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("Form", "FormPages", true, typeof(VenueEntity))]
		...
		{
			var modelList = models.Cast<VenueEntityFormTileEntity>().ToList();
