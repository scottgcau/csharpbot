...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class VenueEntityFormTileEntityType : EfObjectGraphType<SportstatsDBContext, VenueEntityFormTileEntity>
	{
		public VenueEntityFormTileEntityType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			...
			// GraphQL reference to entity VenueEntity via reference Form
	...
	/// </summary>
	public class VenueEntityFormTileEntityInputType : InputObjectGraphType<VenueEntityFormTileEntity>
	{
		public VenueEntityFormTileEntityInputType()
		{
			Name = "VenueEntityFormTileEntityInput";
			Description = "The input object for adding a new VenueEntityFormTileEntity";
			...
			Field<VenueEntityInputType>("Form");
