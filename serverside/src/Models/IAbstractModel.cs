...
namespace Sportstats.Models {
	...
	public interface IAbstractModel
	{
		...
		void BeforeSave(DatabaseSaveOperation operation, SportstatsDBContext dbContext, IServiceProvider serviceProvider);
		void AfterSave(DatabaseSaveOperation operation, SportstatsDBContext dbContext, IServiceProvider serviceProvider);
