...
namespace Sportstats.Models {
	...
	[Table("TeamEntityFormTile")]
	// % protected region % [Configure entity attributes here] end
	public class TeamEntityFormTileEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("Form", "FormPages", true, typeof(TeamEntity))]
		...
		{
			var modelList = models.Cast<TeamEntityFormTileEntity>().ToList();
