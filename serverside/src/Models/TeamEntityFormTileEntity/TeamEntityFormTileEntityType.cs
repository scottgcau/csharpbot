...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class TeamEntityFormTileEntityType : EfObjectGraphType<SportstatsDBContext, TeamEntityFormTileEntity>
	{
		public TeamEntityFormTileEntityType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			...
			// GraphQL reference to entity TeamEntity via reference Form
	...
	/// </summary>
	public class TeamEntityFormTileEntityInputType : InputObjectGraphType<TeamEntityFormTileEntity>
	{
		public TeamEntityFormTileEntityInputType()
		{
			Name = "TeamEntityFormTileEntityInput";
			Description = "The input object for adding a new TeamEntityFormTileEntity";
			...
			Field<TeamEntityInputType>("Form");
