...
namespace Sportstats.Models {
	...
	[Table("RosterassignmentSubmission")]
	// % protected region % [Configure entity attributes here] end
	public class RosterassignmentSubmissionEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("FormVersion", "FormSubmissions", false, typeof(RosterassignmentEntityFormVersion))]
		public RosterassignmentEntityFormVersion FormVersion { get; set; }
		...
		{
			var modelList = models.Cast<RosterassignmentSubmissionEntity>().ToList();
