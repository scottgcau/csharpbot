...
namespace Sportstats.Models {
	...
	[Table("ScheduleSubmission")]
	// % protected region % [Configure entity attributes here] end
	public class ScheduleSubmissionEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("FormVersion", "FormSubmissions", false, typeof(ScheduleEntityFormVersion))]
		public ScheduleEntityFormVersion FormVersion { get; set; }
		...
		{
			var modelList = models.Cast<ScheduleSubmissionEntity>().ToList();
