...
namespace Sportstats.Models
{
	...
	/// </summary>
	public class GameEntityFormVersionType : EfObjectGraphType<SportstatsDBContext, GameEntityFormVersion>
	{
		public GameEntityFormVersionType(IEfGraphQLService<SportstatsDBContext> service) : base(service)
		{
			Description = @"The form versions for the Game Entity form behaviour";
			...
			IEnumerable<GameSubmissionEntity> FormSubmissionsResolveFunction(ResolveFieldContext<GameEntityFormVersion> context)
			{
				var graphQlContext = (SportstatsGraphQlContext) context.UserContext;
				var filter = SecurityService.CreateReadSecurityFilter<GameSubmissionEntity>(
	...
	/// </summary>
	public class GameEntityFormVersionInputType : InputObjectGraphType<GameEntityFormVersion>
	{
		public GameEntityFormVersionInputType()
		{
			Name = "GameEntityFormVersionInput";
			Description = "The input object for adding a new GameEntityFormVersion";
			...
			Field<ListGraphType<GameSubmissionEntityInputType>>("FormSubmissions").Description = @"The submissions for this form version";
