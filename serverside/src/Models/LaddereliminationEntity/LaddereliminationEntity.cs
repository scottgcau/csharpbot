...
namespace Sportstats.Models {
	...
	[Table("Ladderelimination")]
	// % protected region % [Configure entity attributes here] end
	public class LaddereliminationEntity : IOwnerAbstractModel	{
		[Key]
		...
		[EntityForeignKey("Ladder", "Laddereliminationss", false, typeof(LadderEntity))]
		...
		[EntityForeignKey("Round", "Laddereliminationss", false, typeof(RoundEntity))]
		...
		[EntityForeignKey("Team", "Laddereliminationss", false, typeof(TeamEntity))]
		...
		{
			var modelList = models.Cast<LaddereliminationEntity>().ToList();
