...
# SportentityEntity Entity

Details regarding a given SportentityEntity.
...
| ---- | :----: | :--------: | :-----: | ----- | ----- |
| Sportname | STRING | Sally | <i class="fa fa-check"> | <ul><li>Attribute must be entered.</li></ul> | SportName | 
...
The list of records provided a means to see all of the SportentityEntity found in the system. It is broken into pages with navigation between the pages available at the bottom of the list.

The list can be sorted based the the various attributes associated with the SportentityEntity Entity by clicking the columns to sort the list either ascending or desending.
...
1. To create a new SportentityEntity Entity entry click "Create new"
