...
Details regarding a given RoundEntity.
...
| ---- | :----: | :--------: | :-----: | ----- | ----- |
| Order | NUMBER | 42 | <i class="fa fa-check"> | <ul><li>Attribute must be entered.</li></ul> | Numeric round order | 
| Fullname | STRING | Sally | <i class="fa fa-check"> | <ul><li>Attribute must be entered.</li></ul> | Full name | 
...
The list of records provided a means to see all of the RoundEntity found in the system. It is broken into pages with navigation between the pages available at the bottom of the list.

The list can be sorted based the the various attributes associated with the RoundEntity Entity by clicking the columns to sort the list either ascending or desending.
...
1. To create a new RoundEntity Entity entry click "Create new"
